                ...
                <div class="col-lg-12">
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-4 spacing-right">
                            DO Date : <br> <input class="form-control" z name="do_date"
                        ...
                        <div class="col-lg-4 spacing-right">
                            Cell Number <br> <input class="form-control" id="" name="cell_number" type="text"
                                placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Title Of Account <br> <input class="form-control" id="" name="title_of_account"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Office Phone Number : <br> <input class="form-control" id=""
                                name="office_number" type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                        ...
                        <div class="col-lg-4 spacing-right">
                            Rec Staff <br> <input class="form-control" id="" name="rec_staff" type="text"
                                placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Location <br> <input class="form-control" id="" name="location"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Cell Number <br> <input class="form-control" id="" name="rec_cell_number"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            City <br> <input class="form-control" id="" name="rec_city" type="text"
                                placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Fax Number <br> <input class="form-control" id="" name="rec_fax"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Office Phone Number <br> <input class="form-control" id="" name="rec_office_number"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                    </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-4 spacing-right">
                            ...
                            <textarea class="form-control" id="" name="instructions" type="text" placeholder="..."
                        ...
                        <div class="col-lg-4 spacing-right">
                            Tax Rate <br> <input class="form-control" id="" name="tax_rate" type="text"
                                placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Total Tax <br> <input class="form-control" id="" name="total_tax"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Shipping Cost <br> <input class="form-control" id="" name="shipping_cost"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Others <br> <input class="form-control" id="" name="others" type="text"
                                placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Total <br> <input class="form-control" id="" name="total" type="text"
                                placeholder="..." style="width: 100%;">
                        </div>
                    </div>
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-4 spacing-right">
                            Name <br> <input class="form-control" id="" name="raised_by_name"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Cell Number <br> <input class="form-control" id="" name="raised_by_cell" type="text"
                                placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Signature <br> <input class="form-control" id="" name="raised_by_signature"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                    </div>
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-4 spacing-right">
                            Name <br> <input class="form-control" id="" name="vetted_by_name"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Cell Number <br> <input class="form-control" id="" name="vetted_by_cell" type="text"
                                placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Signature <br> <input class="form-control" id="" name="vetted_by_signature"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                    </div>
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-4 spacing-right">
                            Name <br> <input class="form-control" id="" name="approved_by_name"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Cell Number <br> <input class="form-control" id="" name="approved_by_cell" type="text"
                                placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Signature <br> <input class="form-control" id="" name="approved_by_signature"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                    </div>
                </div>
