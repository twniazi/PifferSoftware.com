                ...
                <div id="otherConsultantCollapse${otherConsultantCount}" class="accordion-collapse collapse show" aria-labelledby="otherConsultantHeading${otherConsultantCount}" data-bs-parent="#otherConsultantsAccordion">
                    <div class="accordion-body">
                        ...
                        <div class=" row ">
                            ...
                            <div class="col-lg-4 spacing-left spacing-right mt-3">
                                Notes <br> <textarea class="form-control mt-1" id="" name="otherconsultants[{{ $index }}][other_notes]"
                                name="otherconsultants[${otherConsultantCount - 1}][oth_id]" type="text" placeholder="..." style="width: 100%;">{{ $oth_consultant->other_notes }}</textarea>
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right mt-3">
                                Attachment <br> <input class="form-control mt-1" id="head_office_email"
                        ...
                        <div class="row">
                            <div class="col-lg-5 spacing-right mt-2">
                                Email <br> <input class="form-control mt-1" value="{{ $oth_consultant->other_a_email }}" name="otherconsultants[${otherConsultantCount - 1}][oth_id]" name="otherconsultants[{{ $index }}][other_a_email]" type="email"
                                    placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-5 spacing-left mt-2">
                                Website <br> <input class="form-control mt-1" value="{{ $oth_consultant->other_web }}" name="otherconsultants[${otherConsultantCount - 1}][oth_id]" name="otherconsultants[{{ $index }}][other_web]" type="text"
                                    placeholder="..." style="width: 100%;">
                            </div>
                        </div>
                        <div class="row ">
