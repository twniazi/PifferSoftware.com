...
<div class="customer_form">
    ...
    <div class="modal-header border-0">
                <div style="display:flex; column-gap:10px; align-items:center">
                    ...
                    <h5 class="mt-3" style="font-weight: 700;"> Sub Customers: </h5>
                </div>
              </div>
                        ...
                        @foreach ($subCustomers as $customer)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn " href="{{ route('sub_child_customers', ['customer_id' => $customer->customers_id]) }}">
                                     <img src="https://img.icons8.com/?size=80&id=114064&format=png" width="20px" height="20px">
                                    </a>
