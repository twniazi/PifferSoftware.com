...
<div class="customer_form">
    ...
    <section>
        <form method="POST" action="{{ route('purchaseorder.update', ['id' => $purchaseOrder->id]) }}">
            @csrf
            @method('PUT')
                ...
                <div class="col-lg-12">
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-4 spacing-right">
                            DO Date : <br> <input class="form-control" id="" name="do_date"
                                type="date" value="{{ $purchaseOrder->do_date }}" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            DO Number <br> <input class="form-control" id="" name="do_number"
                                type="text" value="{{ $purchaseOrder->do_number }}" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            PO Date <br> <input class="form-control" id="" name="po_date"
                        ...
                        <div class="col-lg-4 spacing-right">
                            Vendor ID <br> <input class="form-control" id="" name="vendor_id"
                                type="text" value="{{ $purchaseOrder->vendor_id }}" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right ">
                            Name of Bank <br> <input class="form-control" id="" name="name_of_bank"
                                type="text" value="{{ $purchaseOrder->name_of_bank }}" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            POC Name : <br> <input class="form-control" id="" name="poc_name"
                                type="text" value="{{ $purchaseOrder->poc_name }}" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Address of Bank <br> <input class="form-control" id="" name="address_of_bank"
                                type="text" value="{{ $purchaseOrder->address_of_bank }}" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Cell Number <br> <input class="form-control" id="" value="{{ $purchaseOrder->cell_number }}" name="cell_number" type="text"
                                placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Title Of Account <br> <input class="form-control" id="" value="{{ $purchaseOrder->title_of_account }}" name="title_of_account"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Office Phone Number : <br> <input class="form-control" id=""
                                name="office_number" value="{{ $purchaseOrder->office_number }}" type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Account Number <br> <input class="form-control" id="" name="account_number"
                        ...
                        <div class="col-lg-4 spacing-right">
                            Rec Staff <br> <input class="form-control" id="" value="{{ $purchaseOrder->rec_staff }}" name="rec_staff" type="text"
                                placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Location <br> <input class="form-control" id="" value="{{ $purchaseOrder->location }}" name="location"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Cell Number <br> <input class="form-control" id="" value="{{ $purchaseOrder->rec_cell_number }}" name="rec_cell_number"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            City <br> <input class="form-control" id="" value="{{ $purchaseOrder->rec_city }}" name="rec_city" type="text"
                                placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Fax Number <br> <input class="form-control" id="" value="{{ $purchaseOrder->rec_fax }}" name="rec_fax"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Office Phone Number <br> <input class="form-control" id="" value="{{ $purchaseOrder->rec_office_number }}" name="rec_office_number"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                    </div>
                                        ...
                                        <div class="row mb-2" id="signatoryDetailsContainer10">
                                            <div class="col-lg-12" id="consultant_add_fields">
                                                <div class="row mb-2">
                                                    ...
                                                    <div class="col-lg-4 spacing-right">
                                                        Serial Number <br> <input class="form-control" name="purchaseOrderProducts[{{ $index }}][serial_no]" value="{{ $product->serial_no }}" type="text" placeholder="..." style="width: 100%;">
                                                    </div>
                                                    <div class="col-lg-4 spacing-left spacing-right">
                                                        Types <br> <input class="form-control" name="purchaseOrderProducts[{{ $index }}][types]" value="{{ $product->types }}" type="text" placeholder="..." style="width: 100%;">
                                                    </div>
                                                    <div class="col-lg-4 spacing-right">
                                                        Sizes <br> <input class="form-control" name="purchaseOrderProducts[{{ $index }}][sizes]" value="{{ $product->sizes }}" type="text" placeholder="..." style="width: 100%;">
                                                    </div>
                                                    <div class="col-lg-4 spacing-right">
                                                        Quantity <br> <input class="form-control" name="purchaseOrderProducts[{{ $index }}][quantity]" value="{{ $product->quantity }}" type="text" placeholder="..." style="width: 100%;">
                                                    </div>
                                                    <div class="col-lg-4 spacing-left">
                                                        Unit Price <br> <input class="form-control" name="purchaseOrderProducts[{{ $index }}][unit_price]" value="{{ $product->unit_price }}" type="text" placeholder="..." style="width: 100%;">
                                                    </div>
                                                    <div class="col-lg-4 spacing-left">
                                                        Tax <br> <input class="form-control" name="purchaseOrderProducts[{{ $index }}][tax]" value="{{ $product->tax }}" type="text" placeholder="..." style="width: 100%;">
                                                    </div>
                                                    <div class="col-lg-4 spacing-left">
                                                        Total <br> <input class="form-control" name="purchaseOrderProducts[{{ $index }}][total]" value="{{ $product->total }}" type="text" placeholder="..." style="width: 100%;">
                                                    </div>
                                                    <div class="col-lg-4 spacing-left">
                                                        Remarks <br> <input class="form-control" name="purchaseOrderProducts[{{ $index }}][remarks]" value="{{ $product->remarks }}" type="text" placeholder="..." style="width: 100%;">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-4 spacing-right">
                            ...
                            <textarea class="form-control" id="" value="" name="instructions" type="text" placeholder="..."
                                style="width: 100%;">{{ $purchaseOrder->instructions }}</textarea>
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Taxable <br> <input class="form-control" id="" name="taxable"
                                type="text" value="{{ $purchaseOrder->taxable }}" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Tax Rate <br> <input class="form-control" id="" value="{{ $purchaseOrder->tax_rate }}" name="tax_rate" type="text"
                                placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Total Tax <br> <input class="form-control" id="" value="{{ $purchaseOrder->total_tax }}" name="total_tax"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Shipping Cost <br> <input class="form-control" id="" value="{{ $purchaseOrder->shipping_cost }}" name="shipping_cost"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Others <br> <input class="form-control" id="" value="{{ $purchaseOrder->others }}" name="others" type="text"
                                placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Total <br> <input class="form-control" id="" value="{{ $purchaseOrder->total }}" name="total" type="text"
                                placeholder="..." style="width: 100%;">
                        </div>
                    </div>
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-4 spacing-right">
                            Name <br> <input class="form-control" id="" value="{{ $purchaseOrder->raised_by_name }}" name="raised_by_name"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Cell Number <br> <input class="form-control" id="" value="{{ $purchaseOrder->raised_by_cell }}" name="raised_by_cell" type="text"
                                placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Signature <br> <input class="form-control" id="" value="{{ $purchaseOrder->raised_by_signature }}" name="raised_by_signature"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                    </div>
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-4 spacing-right">
                            Name <br> <input class="form-control" id="" value="{{ $purchaseOrder->vetted_by_name }}" name="vetted_by_name"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Cell Number <br> <input class="form-control" id="" value="{{ $purchaseOrder->vetted_by_cell }}" name="vetted_by_cell" type="text"
                                placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Signature <br> <input class="form-control" id="" value="{{ $purchaseOrder->vetted_by_signature }}" name="vetted_by_signature"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                    </div>
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-4 spacing-right">
                            Name <br> <input class="form-control" id="" value="{{ $purchaseOrder->approved_by_name }}" name="approved_by_name"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Cell Number <br> <input class="form-control" id="" value="{{ $purchaseOrder->approved_by_cell }}" name="approved_by_cell" type="text"
                                placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 spacing-right">
                            Signature <br> <input class="form-control" id="" value="{{ $purchaseOrder->approved_by_signature }}" name="approved_by_signature"
                                type="text" placeholder="..." style="width: 100%;">
                        </div>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var purchaseOrderId = '{{ session("purchaseOrderId") }}';

        if (successMessage && purchaseOrderId) {
            var url = '{{ route("view.purchase.order", ":id") }}';
            url = url.replace(':id', purchaseOrderId);
            var popupMessage = 'Purchase Order data stored successfully. Please find the URL below:';
                    ...
                    <div id="signatoryCollapse10${signatoryAccordionCount}" class="collapse" aria-labelledby="signatoryHeading10${signatoryAccordionCount}">
                        <div class="accordion-body">
                            <div class="row mb-2" id="signatoryDetailsContainer10">
                                <div class="col-lg-12" id="consultant_add_fields">
                                    <div class="row mb-2">
                                        <input type="hidden" name="purchaseOrderProducts[${signatoryAccordionCount}][p_id]" value="">
                                        <div class="col-lg-4 spacing-right">
                                            Serial Number <br> <input class="form-control" name="purchaseOrderProducts[${signatoryAccordionCount}][serial_no]" type="text" placeholder="..." style="width: 100%;">
                                        </div>
                                        <div class="col-lg-4 spacing-left spacing-right">
                                            Types <br> <input class="form-control" name="purchaseOrderProducts[${signatoryAccordionCount}][types]" type="text" placeholder="..." style="width: 100%;">
                                        </div>
                                        <div class="col-lg-4 spacing-right">
                                            Sizes <br> <input class="form-control" name="purchaseOrderProducts[${signatoryAccordionCount}][sizes]" type="text" placeholder="..." style="width: 100%;">
                                        </div>
                                        <div class="col-lg-4 spacing-right">
                                            Quantity <br> <input class="form-control" name="purchaseOrderProducts[${signatoryAccordionCount}][quantity]" type="text" placeholder="..." style="width: 100%;">
                                        </div>
                                        <div class="col-lg-4 spacing-left">
                                            Unit Price <br> <input class="form-control" name="purchaseOrderProducts[${signatoryAccordionCount}][unit_price]" type="text" placeholder="..." style="width: 100%;">
                                        </div>
                                        <div class="col-lg-4 spacing-left">
                                            Tax <br> <input class="form-control" name="purchaseOrderProducts[${signatoryAccordionCount}][tax]" type="text" placeholder="..." style="width: 100%;">
                                        </div>
                                        <div class="col-lg-4 spacing-left">
                                            Total <br> <input class="form-control" name="purchaseOrderProducts[${signatoryAccordionCount}][total]" type="text" placeholder="..." style="width: 100%;">
                                        </div>
                                        <div class="col-lg-4 spacing-left">
                                            Remarks <br> <input class="form-control" name="purchaseOrderProducts[${signatoryAccordionCount}][remarks]" type="text" placeholder="..." style="width: 100%;">
                                        </div>
                                    </div>
                                </div>
                            </div>
