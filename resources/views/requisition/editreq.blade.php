                ...
                <div class="row main-content div">
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-6 spacing-right">
                            Name : <br>
                            <input class="form-control" type="text" name="demand_person_name"
                                value="{{ $requisition->demand_person_name }}" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-6 mt-1">
                            Employee ID <br> <input class="form-control" type="text" name="demand_employee_id"
                                value="{{ $requisition->demand_employee_id }}" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-4 mt-1">
                            Cell No. <br> <input class="form-control" name="demand_person_cell"
                                value="{{ $requisition->demand_person_cell }}" type="text" placeholder="..."
                                style="width: 100%;">
                        </div>
                          <div class="col-lg-4 mt-1">
                                        Demand Raised By (Department): <br> <input class="form-control" name="demand_raised_by" value="{{ $requisition->demand_raised_by }}" type="text" placeholder="..."
                                            style="width: 100%;">
                                    </div>
                                      <div class="col-lg-4 mt-1">
                                        Demand Raised To (Department): <br> <input class="form-control" name="demand_raised_to" value="{{ $requisition->demand_raised_to }}" type="text" placeholder="..."
                                            style="width: 100%;">
                                    </div>
                    </div>
                        ...
                        <div class="accordion" id="signatoryAccordion10">
                            ...
                            <div class="accordion-item signaccordion-item10" id="signatoryEntry10">
                                <h2 class="accordion-header" id="signatoryHeading{{ $index + 1 }}" style="color: white">
                                    <button class="accordion-button" style="background-color: #34005A; color:white" type="button" data-toggle="collapse" data-target="#signatoryCollapse{{ $index + 1 }}" aria-expanded="false" aria-controls="signatoryCollapse{{ $index + 1 }}">
                                ...
                                <div id="signatoryCollapse{{ $index + 1 }}" class="collapse" aria-labelledby="signatoryHeading{{ $index + 1 }}">
                                    <div class="accordion-body">
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-lg-6 spacing-right">
                                                Date : <br>
                                                <input class="form-control" type="date" name="reqreports[{{ $index }}][date]" value="{{ $report->date }}" placeholder="..." style="width: 100%;">
                                            </div>
                                            <div class="col-lg-6 spacing-right">
                                               Requisition Number : <br>
                                                <input class="form-control"
                                                    type="text" name="reqreports[{{ $index }}][requisition_no]" value="{{ $report->requisition_no }}" placeholder="..."
                                                    style="width: 100%;">
                                            </div>
                                            <div class="col-lg-6 spacing-right">
                                                Item Name : <br>
                                                <input class="form-control" type="text" name="reqreports[{{ $index }}][item_name]" value="{{ $report->item_name }}" placeholder="..." style="width: 100%;">
                                            </div>
                                            <div class="col-lg-6 mt-1">
                                                Item Code <br>
                                                <input class="form-control" type="text" name="reqreports[{{ $index }}][item_code]" value="{{ $report->item_code }}" placeholder="..." style="width: 100%;">
                                            </div>
                                            <div class="col-lg-6 mt-1">
                                                Quantity <br>
                                                <input class="form-control" name="reqreports[{{ $index }}][quantity]" value="{{ $report->quantity }}" type="text" placeholder="..." style="width: 100%;">
                                            </div>
                                            <div class="col-lg-6 mt-1 spacing-right">
                                                Description : <br>
                                                <input class="form-control" name="reqreports[{{ $index }}][description]" value="{{ $report->description }}" type="text" placeholder="..." style="width: 100%;">
                                            </div>
                                            <div class="col-lg-6 spacing-right">
                                                Manufacturing : <br>
                                                <input class="form-control" name="reqreports[{{ $index }}][manufacturing]" value="{{ $report->manufacturing }}" type="text" placeholder="..." style="width: 100%;">
                                            </div>
                                            <div class="col-lg-6 mt-1">
                                                Size <br>
                                                <input class="form-control" name="reqreports[{{ $index }}][size]" value="{{ $report->size }}" type="text" placeholder="..." style="width: 100%;">
                                            </div>
                                            <div class="col-lg-6 mt-1">
                                                Article No. <br>
                                                <input class="form-control" name="reqreports[{{ $index }}][article_no]" value="{{ $report->article_no }}" type="text" placeholder="..." style="width: 100%;">
                                            </div>
                                            <div class="col-lg-6 mt-1">
                                                Any Special Instructions <br>
                                                <textarea class="form-control mt-1" name="reqreports[{{ $index }}][any_special_ins]" type="text" placeholder="..." style="width: 100%;">{{ $report->any_special_ins }}</textarea>
                                            </div>
                                            <div class="col-lg-6">
                                                Notes <br>
                                                <textarea class="form-control mt-1" name="reqreports[{{ $index }}][notes]" type="text" placeholder="..." style="width: 100%;">{{ $report->notes }}</textarea>
                                            </div>
                                            <div class="col-lg-6">
                                                Attachments <br>
                ...
                <div id="signatoryCollapse10${newIndex}" class="collapse" aria-labelledby="signatoryHeading10${newIndex}" data-bs-parent="#signatoryAccordion10">
                    <div class="accordion-body">
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-6 spacing-right">
                                Date : <br>
                                <input class="form-control" type="date" name="reqreports[${newIndex}][date]" value="" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-6 spacing-right">
                                Item Name : <br>
                                <input class="form-control" type="text" name="reqreports[${newIndex}][item_name]" value="" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-6 mt-1">
                                Item Code <br>
                                <input class="form-control" type="text" name="reqreports[${newIndex}][item_code]" value="" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-6 mt-1">
                                Quantity <br>
                                <input class="form-control" name="reqreports[${newIndex}][quantity]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-6 mt-1 spacing-right">
                                Description : <br>
                                <input class="form-control" name="reqreports[${newIndex}][description]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-6 spacing-right">
                                Manufacturing : <br>
                                <input class="form-control" name="reqreports[${newIndex}][manufacturing]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-6 mt-1">
                                Size <br>
                                <input class="form-control" name="reqreports[${newIndex}][size]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-6 mt-1">
                                Article No. <br>
                                <input class="form-control" name="reqreports[${newIndex}][article_no]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-6 mt-1">
                                Any Special Instructions <br>
