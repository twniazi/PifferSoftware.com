...
@yield('main')
        ...
        <div class="customer_form">
            ...
            <section>
                ...
                <form method="POST" action="{{ route('submitchamber') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="row mb-2" style="margin-left: 20px;">
                            <div class="col d-flex flex-column align-items-end" style="margin-right: 53px;">
                              ...
                              <div class="form-check form-check-inline" style="margin-right: 90px;">
                                <input class="form-check-input mr-2" type="radio" name="chamber_activation" value="1" id="activeRadio">
                                <label class="form-check-label" for="activeRadio">Active</label>

                                <input class="form-check-input ml-3 mr-2" type="radio" name="chamber_activation" value="0" id="inactiveRadio">
                        ...
                        <div class="col-lg-12">
                            <div class="row mb-2">
                                <div class="col-lg-4 spacing-right">
                                    Regulatory ID : <br> <input class="form-control" id="" name="chamber_regulatory_id"
                                        type="text" placeholder="..." style="width: 100%;">
                                </div>
                                <div class="col-lg-4 spacing-right">
                                    Type <br> <input class="form-control" id="" name="chamber_type" type="text"
                                        placeholder="..." style="width: 100%;">
                                </div>
                                <div class="col-lg-4 spacing-right">
                                    Jurisdiction <br> <input class="form-control" id="" name="chamber_jurisdication"
                                        type="text" placeholder="..." style="width: 100%;">
                                </div>
                                <div class="col-lg-4 spacing-right">
                                    Membership No <br> <input class="form-control" id="" name="chamber_membership_no"
                                        type="text" placeholder="..." style="width: 100%;">
                                </div>
                                <div class="col-lg-4 spacing-right">
                                    Serial No <br> <input class="form-control" id="" name="chamber_serial_no"
                                        type="text" placeholder="..." style="width: 100%;">
                                </div>
                                <div class="col-lg-4 spacing-right">
                                    Book No <br> <input class="form-control" id="" name="chamber_book_no" type="text"
                                        placeholder="..." style="width: 100%;">
                                </div>
                                <div class="col-lg-4 spacing-right">
                                    Membership Type <br> <input class="form-control" id=""
                                        name="chamber_membership_type" type="text" placeholder="..."
                                        style="width: 100%;">
                                </div>
                                <div class="col-lg-4 spacing-right">
                                    Member Since <br> <input class="form-control" id="" name="chamber_member_since"
                                        type="date" placeholder="..." style="width: 100%;">
                                </div>
                                <div class="col-lg-4 spacing-right">
                                    Latest Certificate Attachment <br> <input class="form-control" id=""
                                        name="chamber_latest_certification" type="file" placeholder="..."
                                        style="width: 100%;">
                                </div>
                                <div class="col-lg-4 spacing-right">
                                    Validity from : <br> <input class="form-control" id="" name="chamber_validity_from"
                                        type="date" placeholder="..." style="width: 100%;">
                                </div>
                                <div class="col-lg-4 spacing-right">
                                    Expiry Date <br> <input class="form-control" id="" name="chamber_expiry_date"
                                        type="date" placeholder="..." style="width: 100%;">
                                </div>
                                <div class="row mb-2">
                                    <div class="col-lg-4  spacing-right">
                                        Focal Person <br> <input class="form-control" id="head_office_email"
                                            name="chamber_person" type="text" placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-4 spacing-left" style="margin-left:19px;">
                                        Latest Membership Card (front) <br> <input class="form-control" id=""
                                            name="chamber_membership_front" type="file" placeholder="..."
                                            style="width: 100%;">
                                    </div>
                                    <div class="col-lg-4 spacing-right">
                                        Latest Membership Card (back) <br> <input class="form-control" id=""
                                            name="chamber_membership_back" type="file" placeholder="..."
                                            style="width: 100%;">
                                    </div>
                                </div>
                                <div class="col-lg-4 spacing-right">
                                    Notes <br> <textarea class="form-control" id="" name="chamber_notes" type="text"
                                        placeholder="..." style="width: 100%;"></textarea>
                                </div>
                                <div class="col-lg-4 spacing-right">
                                    Attachments <br> <input class="form-control" id="head_office_email"
                                        name="chamber_attachments" type="file" placeholder="..." style="width: 100%;">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-content" style="font-size: small; font-weight: 600;" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade show m-3" style="opacity: 90%;" id="address" role="tabpanel"
                            ...
                            <div class="col-lg-6 spacing-left">
                                <h5>Chamber/Association Address</h5>
                                <div class="row mb-2">
                                    <div class="col-lg-5 spacing-right">
                                        Office No <br> <input class="form-control" id="head_office_cell_no"
                                            name="chamber_a_office" type="text" placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-5 spacing-left">
                                        Building <br> <input class="form-control" id="head_office_cell_no"
                                            name="chamber_a_build" type="text" placeholder="..." style="width: 100%;">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-lg-5 spacing-right">
                                        Block <br> <input class="form-control" id="head_office_cell_no"
                                            name="chamber_a_block" type="text" placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-5 spacing-left">
                                        Area <br> <input class="form-control" id="head_office_cell_no"
                                            name="chamber_a_area" type="text" placeholder="..." style="width: 100%;">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-lg-5 spacing-right">
                                        City <br> <input class="form-control" id="head_office_cell_no"
                                            name="chamber_a_city" type="text" placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-5 spacing-left">
                                        Photograph of Building <br> <input class="form-control" id=""
                                            name="chamber_a_photo" type="file" placeholder="..." style="width: 100%;">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-lg-5 spacing-right">
                                        Email <br> <input class="form-control" id="" name="chamber_a_email" type="text"
                                            placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-5 spacing-left">
                                        Website <br> <input class="form-control" id="" name="chamber_a_website"
                                            type="text" placeholder="..." style="width: 100%;">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-lg-5 spacing-right">
                                        Pin location <br> <input class="form-control" id="" name="chamber_a_pin"
                                            type="text" placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-5 spacing-left">
                                        GPS <br> <input class="form-control" id="" name="chamber_a_gps" type="text"
                                            placeholder="..." style="width: 100%;">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-lg-5 spacing-right">
                                        Notes <br> <textarea class="form-control" id="" name="chamber_a_notes"
                                            type="text" placeholder="..." style="width: 100%;"></textarea>
                                    </div>
                                    <div class="col-lg-5 spacing-left spacing-right">
                                        Attachment <br> <input class="form-control" id="head_office_email"
                                            name="chamber_a_attach" type="file" placeholder="..." style="width: 100%;">
                                    </div>
                                </div>
                            </div>
                        </div>
                                                    ...
                                                    <div class="col-lg-12" id="authority_add_fields">
                                                        <div class="row mb-2">
                                                            <div class="col-lg-3 spacing-right">
                                                                Concerned Officer Name <br> <input class="form-control"
                                                                    id="" name="cofficer_name[]" type="text"
                                                                    placeholder="..." style="width: 100%;">
                                                            </div>
                                                            <div class="col-lg-3 spacing-left spacing-right">
                                                                Designation <br> <input class="form-control"
                                                                    id="head_office_email" name="cofficer_desig[]"
                                                                    type="text" placeholder="..." style="width: 100%;">
                                                            </div>
                                                            <div class="col-lg-3 spacing-right">
                                                                PTCL Number <br> <input class="form-control" id=""
                                                                    name="cofficer_ptcl[]" type="text" placeholder="..."
                                                                    style="width: 100%;">
                                                            </div>
                                                            <div class="col-lg-3 spacing-right">
                                                                Cell Number <br> <input class="form-control" id=""
                                                                    name="cofficer_cell[]" type="text" placeholder="..."
                                                                    style="width: 100%;">
                                                            </div>
                                                            <div class="col-lg-3 spacing-right">
                                                                Email <br> <input class="form-control" id=""
                                                                    name="cofficer_email[]" type="text"
                                                                    placeholder="..." style="width: 100%;">
                                                            </div>
                                                            <div class="col-lg-3 spacing-right">
                                                                Website <br> <input class="form-control" id=""
                                                                    name="cofficer_website[]" type="text"
                                                                    placeholder="..." style="width: 100%;">
                                                            </div>
                                                            <div class="col-lg-3 spacing-right">
                                                                Visiting Card Front <br> <input class="form-control"
                                                                    id="" name="cofficer_front[]" type="file"
                                                                    placeholder="..." style="width: 100%;">
                                                            </div>
                                                            <div class="col-lg-3 spacing-right spacing-left">
                                                                Visiting Card Back <br> <input class="form-control"
                                                                    id="" name="cofficer_back[]" type="file"
                                                                    placeholder="..." style="width: 100%;">
                                                            </div>
                                                            <div class="row mb-2">
                                                                <div class="col-lg-5 spacing-right">
                                                                    Notes <br> <textarea class="form-control" id=""
                                                                        name="cofficer_notes[]" type="text"
                                                                        placeholder="..."
                                                                        style="width: 100%;"></textarea>
                                                                </div>
                                                                <div class="col-lg-5 spacing-left spacing-right">
                                                                    Attachment <br> <input class="form-control"
                                                                        id="head_office_email" name="cofficer_attach[]"
                                                        ...
                                                        <div class="row mb-2">
                                                            <div class="col-lg-3 spacing-right">
                                                                Concerned Officer Name <br> <input class="form-control"
                                                                    id="" name="sj_name[]" type="text" placeholder="..."
                                                                    style="width: 100%;">
                                                            </div>
                                                            <div class="col-lg-3 spacing-left spacing-right">
                                                                Designation <br> <input class="form-control"
                                                                    id="head_office_email" name="sj_desig[]" type="text"
                                                                    placeholder="..." style="width: 100%;">
                                                            </div>
                                                            <div class="col-lg-3 spacing-right">
                                                                PTCL Number <br> <input class="form-control" id=""
                                                                    name="sj_ptcl[]" type="text" placeholder="..."
                                                                    style="width: 100%;">
                                                            </div>
                                                            <div class="col-lg-3 spacing-right">
                                                                Cell Number <br> <input class="form-control" id=""
                                                                    name="sj_cell[]" type="text" placeholder="..."
                                                                    style="width: 100%;">
                                                            </div>
                                                            <div class="col-lg-3 spacing-right">
                                                                Email <br> <input class="form-control" id=""
                                                                    name="sj_email[]" type="text" placeholder="..."
                                                                    style="width: 100%;">
                                                            </div>
                                                            <div class="col-lg-3 spacing-right">
                                                                Website <br> <input class="form-control" id=""
                                                                    name="sj_web[]" type="text" placeholder="..."
                                                                    style="width: 100%;">
                                                            </div>
                                                            <div class="col-lg-3 spacing-right">
                                                                Visiting Card Front <br> <input class="form-control"
                                                                    id="" name="sj_front[]" type="file"
                                                                    placeholder="..." style="width: 100%;">
                                                            </div>
                                                            <div class="col-lg-3 spacing-right spacing-left">
                                                                Visiting Card Back <br> <input class="form-control"
                                                                    id="" name="sj_back[]" type="file" placeholder="..."
                                                                    style="width: 100%;">
                                                            </div>
                                                            <div class="row mb-2">
                                                                <div class="col-lg-5 spacing-right">
                                                                    Notes <br> <textarea class="form-control" id=""
                                                                        name="sj_notes[]" type="text" placeholder="..."
                                                                        style="width: 100%;"></textarea>
                                                                </div>
                                                                <div class="col-lg-5 spacing-left spacing-right">
                                                                    Attachment <br> <input class="form-control"
                                                                        id="head_office_email" name="sj_attach[]"
                                                                        type="file" placeholder="..."
                                                                        style="width: 100%;">
                                                                </div>
                                                            </div>
                            ...
                            <div class="renewal-detials">
                                ...
                                <div class="col-lg-12">
                                    <div class="row mb-2">
                                        ...
                                        <button type="button" class="btn btn-primary mx-4 my-4" id="updateSignatoryTable13">Save</button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade m-3" style="opacity: 90%;" id="law" role="tabpanel"
                            ...
                            <div class="col-lg-12">
                                <div class="row mb-2">
                                    <div class="col-lg-4 spacing-right">
                                        Notes <br> <textarea class="form-control" id="" name="chamber_laws_notes"
                                            type="text" placeholder="..." style="width: 100%;"></textarea>
                                    </div>
                                    <div class="col-lg-4 spacing-left spacing-right">
                                        Attachments <br> <input class="form-control" id="head_office_email"
                                            name="chamber_laws_attach" type="file" placeholder="..."
                                            style="width: 100%;">
                                    </div>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    var chamberId = '{{ session("chamberId") }}';

                    if (successMessage && chamberId) {
                        var url = '{{ route("viewchamber", ":id") }}';
                        url = url.replace(':id', chamberId);
                        var popupMessage = 'Chamber data stored successfully. Please find the URL below:';
            ...
            <script>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-3 spacing-right">
                        Concerned Officer Name  <br> <input class="form-control" id="" name="cofficer_name[]" type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-3 spacing-left spacing-right">
                        Designation <br> <input class="form-control" id="head_office_email" name="cofficer_desig[]" type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-3 spacing-right">
                        PTCL Number <br> <input class="form-control" id="" name="cofficer_ptcl[]" type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-3 spacing-right">
                        Cell Number <br> <input class="form-control" id="" name="cofficer_cell[] " type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-3 spacing-right">
                            Email <br> <input class="form-control" id="" name="cofficer_email[] " type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-3 spacing-right">
                            Website <br> <input class="form-control" id="" name="cofficer_website[] " type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-3 spacing-right">
                            Visiting Card Front <br> <input class="form-control" id="" name="cofficer_front[] " type="file" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-3 spacing-right spacing-left">
                            Visiting Card Back <br> <input class="form-control" id="" name="cofficer_back[] " type="file" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="row mb-2">
                        <div class="col-lg-5 spacing-right">
                            Notes <br> <textarea class="form-control" id="" name="cofficer_notes[] " type="text" placeholder="..." style="width: 100%;"></textarea>
                        </div>
                        <div class="col-lg-5 spacing-left spacing-right">
                            Attachment <br> <input class="form-control" id="head_office_email" name="cofficer_attach[]" type="file" placeholder="..." style="width: 100%;">
                        </div>
                    </div>
                    </div>
                    <h5>Details of Secretary Journal</h5>
                    <div class="row mb-2">
                        <div class="col-lg-3 spacing-right">
                        Concerned Officer Name  <br> <input class="form-control" id="" name="sj_name[]" type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-3 spacing-left spacing-right">
                        Designation <br> <input class="form-control" id="head_office_email" name="sj_desig[]" type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-3 spacing-right">
                        PTCL Number <br> <input class="form-control" id="" name="sj_ptcl[]" type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-3 spacing-right">
                        Cell Number <br> <input class="form-control" id="" name="sj_cell[]" type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-3 spacing-right">
                            Email <br> <input class="form-control" id="" name="sj_email[]" type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-3 spacing-right">
                            Website <br> <input class="form-control" id="" name="sj_web[]" type="text" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-3 spacing-right">
                            Visiting Card Front <br> <input class="form-control" id="" name="sj_front[]" type="file" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="col-lg-3 spacing-right spacing-left">
                            Visiting Card Back <br> <input class="form-control" id="" name="sj_back[]" type="file" placeholder="..." style="width: 100%;">
                        </div>
                        <div class="row mb-2">
                        <div class="col-lg-5 spacing-right">
                            Notes <br> <textarea class="form-control" id="" name="sj_notes[]" type="text" placeholder="..." style="width: 100%;"></textarea>
                        </div>
                        <div class="col-lg-5 spacing-left spacing-right">
                            Attachment <br> <input class="form-control" id="head_office_email" name="sj_attach[]" type="file" placeholder="..." style="width: 100%;">
                        </div>
                    </div>
                    </div>
                </div>
                    ...
                    $('#addSignatory11').on('click', function () {
                        ...
                        var newSignAccordion11 = `
                            <div class="accordion-item signaccordion-item11" id="signatoryEntry11${SignatoryAccordionCount11}">
                                ...
                                <div class="row mb-2">
                                    <div class="col-lg-3 spacing-right">
                                        Concerned Officer Name <br> <input class="form-control" id=""
                                            name="cofficer_name[]" type="text" placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-3 spacing-left spacing-right">
                                        Designation <br> <input class="form-control" id="head_office_email"
                                            name="cofficer_desig[]" type="text" placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-3 spacing-right">
                                        PTCL Number <br> <input class="form-control" id="" name="cofficer_ptcl[]"
                                            type="text" placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-3 spacing-right">
                                        Cell Number <br> <input class="form-control" id="" name="cofficer_cell[]"
                                            type="text" placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-3 spacing-right">
                                        Email <br> <input class="form-control" id="" name="cofficer_email[]" type="text"
                                            placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-3 spacing-right">
                                        Website <br> <input class="form-control" id="" name="cofficer_website[]"
                                            type="text" placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-3 spacing-right">
                                        Visiting Card Front <br> <input class="form-control" id=""
                                            name="cofficer_front[]" type="file" placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-3 spacing-right spacing-left">
                                        Visiting Card Back <br> <input class="form-control" id="" name="cofficer_back[]"
                                            type="file" placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-lg-5 spacing-right">
                                            Notes <br> <textarea class="form-control" id="" name="cofficer_notes[]"
                                                type="text" placeholder="..." style="width: 100%;"></textarea>
                                        </div>
                                        <div class="col-lg-5 spacing-left spacing-right">
                                            Attachment <br> <input class="form-control" id="head_office_email"
                                                name="cofficer_attach[]" type="file" placeholder="..."
                                                style="width: 100%;">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-2">
                                    <div class="col-lg-3 spacing-right">
                                        Concerned Officer Name <br> <input class="form-control" id="" name="sj_name[]"
                                            type="text" placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-3 spacing-left spacing-right">
                                        Designation <br> <input class="form-control" id="head_office_email"
                                            name="sj_desig[]" type="text" placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-3 spacing-right">
                                        PTCL Number <br> <input class="form-control" id="" name="sj_ptcl[]" type="text"
                                            placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-3 spacing-right">
                                        Cell Number <br> <input class="form-control" id="" name="sj_cell[]" type="text"
                                            placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-3 spacing-right">
                                        Email <br> <input class="form-control" id="" name="sj_email[]" type="text"
                                            placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-3 spacing-right">
                                        Website <br> <input class="form-control" id="" name="sj_web[]" type="text"
                                            placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-3 spacing-right">
                                        Visiting Card Front <br> <input class="form-control" id="" name="sj_front[]"
                                            type="file" placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-3 spacing-right spacing-left">
                                        Visiting Card Back <br> <input class="form-control" id="" name="sj_back[]"
                                            type="file" placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-lg-5 spacing-right">
                                            Notes <br> <textarea class="form-control" id="" name="sj_notes[]"
                                                type="text" placeholder="..." style="width: 100%;"></textarea>
                                        </div>
                                        <div class="col-lg-5 spacing-left spacing-right">
                                            Attachment <br> <input class="form-control" id="head_office_email"
                                                name="sj_attach[]" type="file" placeholder="..." style="width: 100%;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                $(document).ready(function () {
                    ...
                    function updateSignatorySummaryTable11() {
                        ...
                        $('.signaccordion-item11').each(function (index) {
                            var name = $(this).find('[name="cofficer_name[]"]').val();
                            var designation = $(this).find('[name="cofficer_desig[]"]').val();
                            var PTCL_Number = $(this).find('[name="cofficer_ptcl[]"]').val();
                            var Cell_Number = $(this).find('[name="cofficer_cell[]"]').val();
                            var Email = $(this).find('[name="cofficer_email[]"]').val();
                            console.log(name);
                            console.log(designation);
                            console.log(PTCL_Number);
                            // Check if any relevant data is entered
                            if (name || designation || PTCL_Number || Cell_Number || Email) {
                                // Add a new row to the summary table
