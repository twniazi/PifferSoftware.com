...
<div class="customer_form">
    ...
    <section>
        ...
        <form action="{{ route('update_regulator', ['id' => $regulators->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class=" row main-content div">
                <div class="col-lg-12">
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-4 spacing-right">
                            Type <br> <input class="form-control mt-1" id="head_office_name" name="reg_type" value="{{ $regulators->reg_type }}" type="text"
                        ...
                        <div class="col-lg-4 spacing-right mt-3">
                            ...
                            <div class="col-lg-5 spacing-right" style="margin-left:-28px;">
                                <div class="preview-container" id="previewContainer" style="display: flex; flex-direction: row; align-items: center;">
                                    @if($regulators->license_attach)
                                        @php
                                            $attachments = explode(',', $regulators->license_attach);
                                        @endphp
                        ...
                        <div class="col-lg-4 spacing-right mt-3">
                            Validity from : <br> <input class="form-control mt-1" id="head_office_name" name="validity_from"
                    ...
                    <div class="row mb-2">
                        <div class="col-lg-4 spacing-right mt-3">
                            ...
                            type="text" placeholder="..." style="width: 100%;">{{ $regulators->notes }}</textarea>
                        </div>
                        <div class="col-lg-4 spacing-right mt-3">
                            Attachments <br> <input class="form-control mt-1" id="head_office_name" name="attachments[]"
                            value="{{ $regulators->attachments }}"    type="file" multiple placeholder="..." style="width: 100%;">
                            <div class="col-lg-5 spacing-right" style="margin-left:-28px;">
                                <div class="preview-container" id="previewContainer" style="display: flex; flex-direction: row; align-items: center;">
                                    @if($regulators->attachments)
                                        @php
                                            $attachments = explode(',', $regulators->attachments);
                                        @endphp
                                        @foreach ($attachments as $attachment)
                                            <div style="padding: 10px;">
                                                @if (Str::endsWith($attachment, ['.jpg', '.jpeg', '.png', '.gif', '.bmp']))
                ...
                <div class="tab-pane fade show active m-3" style="opacity: 90%;" id="operating" role="tabpanel"
                    ...
                    <div class="tab-content" style="font-size: small; font-weight: 600;" id="nav-tabContent">
                                        ...
                                        <div class="accordion-item" id="consultantItem{{ $index + 1 }}">
                                            ...
                                            <div id="consultantCollapse{{ $index + 1 }}" class="accordion-collapse collapse show" aria-labelledby="consultantHeading{{ $index + 1 }}" data-bs-parent="#consultantsAccordion">
                                                <div class="accordion-body">
                                                    <div class=" row mb-2">
                                                        <input type="hidden" name="operatingconsultants[{{ $index }}][opc_id]" value="{{ $op_consultant->id }}">
                                                        <div class="col-lg-4 spacing-right">
                                                    ...
                                                    <div class=" row ">
                                                        ...
                                                        <div class="col-lg-4 spacing-left spacing-right mt-3">
                                                            Notes <br> <textarea class="form-control mt-1" name="operatingconsultants[{{ $index }}][oper_notes]"
                                                                type="text" placeholder="..." style="width: 100%;">{{ $op_consultant->oper_notes }}</textarea>
                                                        </div>
                                                        <div class="col-lg-4 spacing-left spacing-right mt-3">
                                                            Attachment <br> <input class="form-control mt-1" value="{{ $op_consultant->oper_attachments }}" id="head_office_email"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-5 spacing-right mt-2">
                                                            Email <br> <input class="form-control mt-1" value="{{ $op_consultant->oper_a_email }}" name="operatingconsultants[{{ $index }}][oper_a_email]" type="email"
                                                                placeholder="..." style="width: 100%;">
                                                        </div>
                                                        <div class="col-lg-5 spacing-left mt-2">
                                                            Website <br> <input class="form-control mt-1" value="{{ $op_consultant->oper_web }}" name="operatingconsultants[{{ $index }}][oper_web]" type="text"
                                                                placeholder="..." style="width: 100%;">
                                                        </div>
                                                    </div>
                                                    <div class="row ">
                                                        <div class="col-lg-5 spacing-right mt-2">
                                                            Pin location <br> <input class="form-control mt-1" value="{{ $op_consultant->oper_pin }}" name="operatingconsultants[{{ $index }}][oper_pin]"
                                                                type="text" placeholder="..." style="width: 100%;">
                                                        </div>
                                                        <div class="col-lg-5 spacing-left mt-2">
                                                            GPS <br> <input class="form-control mt-1" value="{{ $op_consultant->oper_gps }}" name="operatingconsultants[{{ $index }}][oper_gps]" type="text"
                                                                placeholder="..." style="width: 100%;">
                                                        </div>
                                                    </div>
                                                    <div class="row ">
                                                        <div class="col-lg-5 spacing-right mt-2">
                                                            Notes <br> <textarea class="form-control mt-1" name="operatingconsultants[{{ $index }}][oper_ex_notes]"
                                                                type="text" placeholder="..." style="width: 100%;">{{ $op_consultant->oper_ex_notes }}</textarea>
                                                        </div>
                                                        <div class="col-lg-5 spacing-left mt-2">
                                                            Attachments <br> <input class="form-control mt-1" value="{{ $op_consultant->oper_ex_attach }}" name="operatingconsultants[{{ $index }}][oper_ex_attach]"
                                    ...
                                    <div class="col-lg-5 spacing-right">
                                        Notes <br> <textarea class="form-control" id="head_office_name"
                                            name="oper_home_notes" type="text" placeholder="..."
                                             style="width: 100%;">{{ $regulators->oper_home_notes }}</textarea>
                                    </div>
                                    <div class="col-lg-5 spacing-left">
                        ...
                        <div class="tab-pane fade m-3" style="opacity: 90%;" id="issuing" role="tabpanel"
                            ...
                            <div class="col-lg-12" id="operating_authority_add_fields">
                                ...
                                <div class="accordion-item" id="operatingAuthorityItem{{ $index }}">
                                    ...
                                    <div id="operatingAuthorityCollapse{{ $index }}" class="accordion-collapse collapse show" aria-labelledby="operatingAuthorityHeading{{ $index }}" data-bs-parent="#operatingAuthorityAccordion">
                                        <div class="accordion-body">
                                            <div class="row mb-2">
                                                <input type="hidden" name="operatingissuings[{{ $index }}][opi_id]" value="{{ $op_issuing->id }}">
                                                ...
                                                <div class="row mb-2 mt-2">
                                                    <div class="col-lg-5 spacing-right mt-3">
                                                        ...
                                                        name="operatingissuings[{{ $index }}][oper_iss_co_notes]" type="text" placeholder="..."
                                                            style="width: 100%;">{{ $op_issuing->oper_iss_co_notes }}</textarea>
                                                    </div>
                            ...
                            <button type="button" id="addOperatingAuthority" class="btn btn-primary">Add More Operating Authority Entry</button>
                        ...
                        <div class="tab-pane fade m-3" style="opacity: 90%;" id="operating_renewals" role="tabpanel"
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-4 spacing-right">
                                        Notes <br> <textarea class="form-control mt-1" id="head_office_name"
                                            ...
                                            style="width: 100%;">{{ $regulators->oper_ra_notes }}</textarea>
                                    </div>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-4 spacing-right">
                                        Notes <br> <textarea class="form-control mt-1" id="head_office_name"
                                            ...
                                            style="width: 100%;">{{ $regulators->oper_rc_notes }}</textarea>
                                    </div>
                                    <div class="col-lg-4 spacing-right">
                                        Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-4 spacing-right">
                                        Notes <br> <textarea class="form-control mt-1" id="head_office_name"
                                            ...
                                            style="width: 100%;">{{ $regulators->oper_rap_notes }}</textarea>
                                    </div>
                                    <div class="col-lg-4 spacing-right">
                                        Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                    ...
                                    <div id="operatingRenewalCollapse{{ $index }}" class="accordion-collapse collapse show" aria-labelledby="operatingRenewalHeading{{ $index }}" data-bs-parent="#operatingRenewalsAccordion">
                                        <div class="accordion-body">
                                            <div>
                                                ...
                                                <input type="hidden" name="operatingrenewals[{{ $index }}][opr_id]" value="{{ $op_renewal->id }}">
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-lg-4 spacing-left spacing-right mt-3">
                                                            ...
                                                            name="operatingrenewals[{{ $index }}][oper_finance_notes]" type="text" placeholder="..."
                                                                style="width: 100%;">{{ $op_renewal->oper_finance_notes }}</textarea>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-4 spacing-left spacing-right mt-3">
                                                            ...
                                                            name="operatingrenewals[{{ $index }}][oper_finance_wb_notes]" type="text" placeholder="..."
                                                                style="width: 100%;">{{ $op_renewal->oper_finance_wb_notes }}</textarea>
                                                        </div>
                                                        <div class="col-lg-4 spacing-right">
                                                            Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                                        ...
                                                        <div class="col-lg-4 spacing-left spacing-right mt-3">
                                                            ...
                                                            name="operatingrenewals[{{ $index }}][oper_finance_db_notes]" type="text" placeholder="..."
                                                                style="width: 100%;">{{ $op_renewal->oper_finance_db_notes }}</textarea>
                                                        </div>
                                                        <div class="col-lg-4 spacing-right">
                                                            Attachments <br> <input class="form-control mt-1" id="head_office_email"
                            ...
                            <button type="button" id="addOperatingRenewal" class="btn btn-primary">Add More Operating Authority Entry</button>
                        </div>
                        <!--Laws-->
                                ...
                                <div class="row mb-2">
                                    <div class="col-lg-4 spacing-right">
                                        Notes <br> <textarea class="form-control mt-1" id="head_office_name"
                                            ...
                                            style="width: 100%;">{{ $regulators->oper_laws_notes }}</textarea>
                                    </div>
                                    <div class="col-lg-4 spacing-left spacing-right">
                                        Attachments <br> <input class="form-control mt-1" id="head_office_email"
                ...
                <div class="tab-pane fade m-3" style="opacity: 90%;" id="weapon" role="tabpanel"
                    ...
                    <div class="tab-content" style="font-size: small; font-weight: 600;" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade show active m-3" style="opacity: 90%;" id="w_consultant"
                            ...
                            <div id="weaponConsultantsAccordion">
                                ...
                                <div class="accordion-item" id="weaponConsultantItem{{ $index }}">
                                    ...
                                    <div id="weaponConsultantCollapse{{ $index }}" class="accordion-collapse collapse show" aria-labelledby="weaponConsultantHeading{{ $index }}" data-bs-parent="#weaponConsultantsAccordion">
                                        <div class="accordion-body">
                                            <input type="hidden" name="weaponconsultants[{{ $index }}][we_id]" value="">
                                            <div class=" row mb-2">
                                                <div class="col-lg-4 spacing-right">
                                                    Bank Name <br> <input class="form-control mt-1" id="head_office_name"
                                                ...
                                                <div class="col-lg-4 spacing-left spacing-right mt-3">
                                                    Notes <br> <textarea class="form-control mt-1" id="" name="weaponconsultants[{{ $index }}][wep_notes]"
                                                        type="text" placeholder="..." style="width: 100%;">{{ $we_consultant->wep_notes }}</textarea>
                                                </div>
                                                <div class="col-lg-4 spacing-left spacing-right mt-3">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-lg-5 spacing-right mt-2">
                                                    Email <br> <input class="form-control mt-1" value="{{ $we_consultant->wep_a_email }}" name="weaponconsultants[{{ $index }}][wep_a_email]" type="text"
                                                        placeholder="..." style="width: 100%;">
                                                </div>
                                                <div class="col-lg-5 spacing-left mt-2">
                                                    Website <br> <input class="form-control mt-1" value="{{ $we_consultant->wep_web }}" name="weaponconsultants[{{ $index }}][wep_web]" type="text"
                                                        placeholder="..." style="width: 100%;">
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-lg-5 spacing-right mt-2">
                                                    Pin location <br> <input class="form-control mt-1" value="{{ $we_consultant->wep_pin }}" name="weaponconsultants[{{ $index }}][wep_pin]""
                                                        type="text" placeholder="..." style="width: 100%;">
                                                </div>
                                                <div class="col-lg-5 spacing-left mt-2">
                                                    GPS <br> <input class="form-control mt-1" value="{{ $we_consultant->wep_gps }}" name="weaponconsultants[{{ $index }}][wep_gps]" type="text"
                                                        placeholder="..." style="width: 100%;">
                                                </div>
                                            </div>
                                            <div class="row ">
                                                <div class="col-lg-5 spacing-right ">
                                                    Notes <br> <textarea class="form-control mt-1" name="weaponconsultants[{{ $index }}][wep_ex_notes]"
                                                        type="text" placeholder="..." style="width: 100%;">{{ $we_consultant->wep_ex_notes }}</textarea>
                                                </div>
                                                <div class="col-lg-5 spacing-left">
                                                    Attachments <br> <input class="form-control mt-1" value="{{ $we_consultant->wep_ex_attach }}" name="weaponconsultants[{{ $index }}][wep_ex_attach]"
                                                    type="file" placeholder="..." style="width: 100%;">
                                                    <div class="col-lg-5 spacing-right">
                                                        <!-- Image Preview Biometric -->
                                                        <div class="image-preview42" id="imagePreview42">
                            ...
                            <!-- Button to add more weapon consultant entries -->
                            <button type="button" id="addWeaponConsultant" class="btn btn-primary">Add More Weapon Consultant</button>
                        ...
                        <div class="tab-pane fade m-3" style="opacity: 90%;" id="w_address" role="tabpanel"
                            ...
                            <div class="col-lg-6 spacing-left">
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-lg-5 spacing-left">
                                        GPS <br> <input class="form-control mt-1" value="{{ $regulators->wep_home_pin }}" name="wep_home_pin" type="text"
                                            placeholder="..." style="width: 100%;">
                                    </div>
                                </div>
                                <div class="row mb-2 mt-3">
                                    <div class="col-lg-5 spacing-right">
                                        Notes <br> <textarea class="form-control" id="" name="wep_home_notes"
                                            type="text" placeholder="..." style="width: 100%;">{{ $regulators->wep_home_notes }}</textarea>
                                    </div>
                                    <div class="col-lg-5 spacing-left">
                        ...
                        <div class="tab-pane fade m-3" style="opacity: 90%;" id="w_issuing" role="tabpanel"
                                ...
                                <div class="accordion-item" id="weaponIssuingItem{{ $index }}">
                                    ...
                                    <div id="weaponIssuingCollapse{{ $index }}" class="accordion-collapse collapse show" aria-labelledby="weaponIssuingHeading{{ $index }}" data-bs-parent="#weaponIssuingsAccordion">
                                        <div class="accordion-body">
                                            ...
                                            <div>
                                                <input type="hidden" name="weaponissuings[{{ $index }}][wei_id]" value="{{ $we_issuing->id }}">
                                                <div class="col-lg-12" >
                                                    <div class="row mb-2">
                                                        <div class="col-lg-3 spacing-right">
                                                            Concerned Officer Name <br> <input class="form-control mt-1"
                                                        ...
                                                        <div class="row mb-2 mt-3">
                                                            <div class="col-lg-4 spacing-right">
                                                                Notes <br> <textarea class="form-control mt-1" id="" name="weaponissuings[{{ $index }}][wep_iss_co_notes]"
                                                                    type="text" placeholder="..." style="width: 100%;">{{ $we_issuing->wep_iss_co_notes }}</textarea>
                                                            </div>
                                                            <div class="col-lg-4 spacing-left">
                                                                Attachments <br> <input class="form-control mt-1" id="" name="weaponissuings[{{ $index }}][wep_iss_co_attach]"
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col-lg-4 spacing-right">
                                                            ...
                                                            name="weaponissuings[{{ $index }}][wep_co_p_notes]" type="text" placeholder="..."
                                                                style="width: 100%;">{{ $we_issuing->wep_co_p_notes }}</textarea>
                                                        </div>
                                                        <div class="col-lg-4 spacing-right">
                                                            Attachments <br> <input class="form-control mt-1" id="head_office_email"
                            ...
                            <!-- Button to add more weapon issuing entries -->
                            <button type="button" id="addWeaponIssuing" class="btn btn-primary">Add More Weapon Issuing Entry</button>
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-4 spacing-right">
                                        Notes <br> <textarea class="form-control mt-1" id="head_office_name"
                                            ...
                                            style="width: 100%;">{{ $regulators->wep_ra_notes }}</textarea>
                                    </div>
                                    <div class="col-lg-4 spacing-left">
                                        Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-4 spacing-right">
                                        Notes <br> <textarea class="form-control mt-1" id="head_office_name"
                                            ...
                                            style="width: 100%;">{{ $regulators->wep_rc_notes }}</textarea>
                                    </div>
                                    <div class="col-lg-4 spacing-right">
                                        Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-4 spacing-right">
                                        Notes <br> <textarea class="form-control mt-1" id="head_office_name"
                                            ...
                                            style="width: 100%;">{{ $regulators->wep_rap_notes }}</textarea>
                                    </div>
                                    <div class="col-lg-4 spacing-right">
                                        Attachments <br> <input class="form-control mt-1" id="head_office_email"
                            ...
                            <div class="col-lg-12">
                                <div class="row mb-2">
                                    <div class="row legal_fee">
                                        ...
                                        {{-- <input type="hidden" name="weaponlegals[{{ $index }}][le_id]" value="{{ $legal->id }}"> --}}
                                        <div class="col-lg-4 spacing-right">
                                            Bank Name <br> <input class="form-control mt-1" id="head_office_name"
                                        ...
                                        <div class="col-lg-4 spacing-left spacing-right mt-3">
                                            ...
                                            name="weaponlegals[{{ $index }}][wep_legal_notes]"  type="text" placeholder="..."
                                                style="width: 100%;">{{ $legal->wep_legal_notes }}</textarea>
                                        </div>
                                        <div class="col-lg-4 spacing-left spacing-right mt-3">
                                            Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                        ...
                                        <div class="col-lg-4 spacing-left spacing-right mt-3">
                                            ...
                                            name="weaponlegals[{{ $index }}][wep_legal_wb_notes]" type="text" placeholder="..."
                                                style="width: 100%;">{{ $legal->wep_legal_wb_notes }}</textarea>
                                        </div>
                                        <div class="col-lg-4 spacing-right">
                                            Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                        ...
                                        <div class="col-lg-4 spacing-right mt-3">
                                            ...
                                            name="weaponlegals[{{ $index }}][wep_legal_fee_notes]" type="text" placeholder="..."
                                                style="width: 100%;">{{ $legal->wep_legal_fee_notes }}</textarea>
                                        </div>
                                        <div class="col-lg-4 spacing-left spacing-right mt-3">
                                            Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                        ...
                                        <div class="col-lg-4 spacing-left spacing-right mt-3">
                                            ...
                                            name="weaponlegals[{{ $index }}][wep_legal_db_notes]" type="text" placeholder="..."
                                                style="width: 100%;">{{ $legal->wep_legal_db_notes }}</textarea>
                                        </div>
                                        <div class="col-lg-4 spacing-right">
                                            Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                    ...
                                    <div id="weapon_finance_add_fields">
                                        ...
                                        <input type="hidden" name="weaponrenewals[{{ $index }}][wer_id]" value="{{ $we_renewals->id }}">
                                        <h3 style="border: 2px solid black; width: 99%; padding: 10px;"><b>Finances :</b></h3>
                                        <div class="col-lg-6 spacing-right mb-3">
                                            Category <br> <input class="form-control mt-1" id="head_office_name"
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-lg-4 spacing-left spacing-right mt-3">
                                                    ...
                                                    name="weaponrenewals[{{ $index }}][wep_finance_notes]" type="text" placeholder="..."
                                                        style="width: 100%;">{{ $we_renewals->wep_finance_notes }}</textarea>
                                                </div>
                                                <div class="col-lg-4 spacing-left spacing-rightmt-3">
                                                    Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                                ...
                                                <div class="col-lg-4 spacing-left spacing-right mt-3">
                                                    ...
                                                    name="weaponrenewals[{{ $index }}][wep_finance_wb_notes]" type="text" placeholder="..."
                                                        style="width: 100%;">{{ $we_renewals->wep_finance_wb_notes }}</textarea>
                                                </div>
                                                <div class="col-lg-4 spacing-right">
                                                    Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                                ...
                                                <div class="col-lg-4 spacing-right mt-3">
                                                    ...
                                                    name="weaponrenewals[{{ $index }}][wep_finance_fee_notes]" type="text" placeholder="..."
                                                        style="width: 100%;">{{ $we_renewals->wep_finance_fee_notes }}</textarea>
                                                </div>
                                                <div class="col-lg-4 spacing-left spacing-right mt-3">
                                                    Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                                ...
                                                <div class="col-lg-4 spacing-left spacing-right mt-3">
                                                    ...
                                                    name="weaponrenewals[{{ $index }}][wep_finance_db_notes]" type="text" placeholder="..."
                                                        style="width: 100%;">{{ $we_renewals->wep_finance_db_notes }}</textarea>
                                                </div>
                                                <div class="col-lg-4 spacing-right">
                                                    Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                    ...
                                    <div>
                                        ...
                                        <input type="hidden" name="weapondivisions[{{ $index }}][wed_id]" value="{{ $division->id }}">
                                                ...
                                                <div class="col-lg-4 mt-4">
                                                    <div class=" mb-2 d-flex align-items-center ">
                                                        <div class="form-check form-check-inline spacing-left ">
                                                            <input class="form-check-input" {{ $division->division_book ? 'checked' : '' }} name="division_book[]"
                                                ...
                                                <div class="col-lg-4 mt-2">
                                                    <div class=" mb-2 d-flex align-items-center m-5">
                                                        <div class="form-check form-check-inline spacing-left mt-2">
                                                            <input class="form-check-input" {{ $division->division_nbp ? 'checked' : '' }} name="division_nbp[]"
                                                                type="checkbox" id="inlineCheckbox1" value="">
                                                            <label class="form-check-label"
                                                                for="inlineCheckbox1">NBP</label>
                                                        </div>
                                                        <div class="form-check form-check-inline spacing-left mt-2">
                                                            <input class="form-check-input" {{ $division->division_pb ? 'checked' : '' }} name="division_pb[]"
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-lg-6 spacing-right">
                                                Notes <br> <textarea class="form-control mt-1" id="head_office_name"
                                                    ...
                                                    style="width: 100%;">{{ $division->division_notes }}</textarea>
                                            </div>
                                            <div class="col-lg-6 spacing-right">
                                                Attachments <br> <input class="form-control mt-1" id="head_office_email"
                        ...
                        <div class="tab-pane fade m-3" style="opacity: 90%;" id="w_details" role="tabpanel"
                            ...
                            <div id="weaponAccordion">
                                <!-- Existing weapon details entries -->
                                @foreach ($regulators->weaponlicenses as $index => $license)
                                <div class="accordion-item" id="weaponItem{{ $index }}">
                                    <h2 class="accordion-header" id="weaponHeading{{ $index }}">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#weaponCollapse{{ $index }}" aria-expanded="true" aria-controls="weaponCollapse{{ $index }}">
                                            Weapon Details {{ $index + 1 }}
                                        </button>
                                    </h2>
                                    <div id="weaponCollapse{{ $index }}" class="accordion-collapse collapse show" aria-labelledby="weaponHeading{{ $index }}" data-bs-parent="#weaponAccordion">
                                        <div class="accordion-body">
                                            <input type="hidden" name="weaponlicenses[{{ $index }}][lic_id]" value="{{ $license->id }}">
                                            <div class="row mb-2">
                                                <div class="col-lg-4 spacing-left spacing-right">
                                                ...
                                                <div class="row mb-2">
                                                    <div class="col-lg-5 spacing-left" style="margin-left: -20px">
                                                        ...
                                                        name="weaponlicenses[{{ $index }}][wep_lic_ex_notes]" type="text" placeholder="..."
                                                            style="width: 87%;">{{ $license->wep_lic_ex_notes }}</textarea>
                                                    </div>
                            ...
                            <!-- Button to add more weapon details entries -->
                            <button type="button" id="addWeaponEntry" class="btn btn-primary">Add More Weapon Details</button>
                        </div>
                        <!--Laws-->
                                ...
                                <div class="row mb-2">
                                    <div class="col-lg-4 spacing-right">
                                        Notes <br> <textarea class="form-control mt-1" id="head_office_name"
                                            ...
                                            style="width: 100%;">{{ $regulators->wep_laws_notes }}</textarea>
                                    </div>
                                    <div class="col-lg-4 spacing-left spacing-right">
                                        Attachments <br> <input class="form-control mt-1" id="head_office_email"
                ...
                <div class="tab-pane fade m-3" style="opacity: 90%;" id="any_other" role="tabpanel"
                    ...
                    <div class="tab-content" style="font-size: small; font-weight: 600;" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade show active m-3" style="opacity: 90%;" id="a_consultant"
                            ...
                            <div id="otherConsultantsAccordion">
                                ...
                                <div class="accordion-item" id="otherConsultantItem{{ $index }}">
                                    ...
                                    <div id="otherConsultantCollapse{{ $index }}" class="accordion-collapse collapse show" aria-labelledby="otherConsultantHeading{{ $index }}" data-bs-parent="#otherConsultantsAccordion">
                                        <div class="accordion-body">
                                            <div class=" row mb-2">
                                                <input type="hidden" name="otherconsultants[{{ $index }}][oth_id]" value="{{ $oth_consultant->id }}">
                                                <div class="col-lg-4 spacing-right">
                                                    Consultant Name <br> <input class="form-control mt-1" id="head_office_name"
                                            ...
                                            <div class=" row ">
                                                ...
                                                <div class="col-lg-4 spacing-left spacing-right mt-3">
                                                    Notes <br> <textarea class="form-control mt-1" id="" name="otherconsultants[{{ $index }}][other_notes]"
                                                        type="text" placeholder="..." style="width: 100%;">{{ $oth_consultant->other_notes }}</textarea>
                                                </div>
                                                <div class="col-lg-4 spacing-left spacing-right mt-3">
                                                    Attachment <br> <input class="form-control mt-1" id="head_office_email"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-5 spacing-right mt-2">
                                                    Email <br> <input class="form-control mt-1" value="{{ $oth_consultant->other_a_email }}" name="otherconsultants[{{ $index }}][other_a_email]" type="email"
                                                        placeholder="..." style="width: 100%;">
                                                </div>
                                                <div class="col-lg-5 spacing-left mt-2">
                                                    Website <br> <input class="form-control mt-1" value="{{ $oth_consultant->other_web }}" name="otherconsultants[{{ $index }}][other_web]" type="text"
                                                        placeholder="..." style="width: 100%;">
                                                </div>
                                            </div>
                                            <div class="row ">
                                                <div class="col-lg-5 spacing-right mt-2">
                                                    Pin location <br> <input class="form-control mt-1" value="{{ $oth_consultant->other_pin }}" name="otherconsultants[{{ $index }}][other_pin]"
                                                        type="text" placeholder="..." style="width: 100%;">
                                                </div>
                                                <div class="col-lg-5 spacing-left mt-2">
                                                    GPS <br> <input class="form-control mt-1" value="{{ $oth_consultant->other_gps }}" name="otherconsultants[{{ $index }}][other_gps]" type="text"
                                                        placeholder="..." style="width: 100%;">
                                                </div>
                                            </div>
                                            <div class="row ">
                                                <div class="col-lg-5 spacing-right mt-2">
                                                    Notes <br> <textarea class="form-control mt-1" id="" name="otherconsultants[{{ $index }}][other_ex_notes]"
                                                        type="text" placeholder="..." style="width: 100%;">{{ $oth_consultant->other_ex_notes }}</textarea>
                                                </div>
                                                <div class="col-lg-5 spacing-left mt-2">
                                                    Attachments <br> <input class="form-control mt-1" value="{{ $oth_consultant->other_ex_attach }}" name="otherconsultants[{{ $index }}][other_ex_attach]"
                                                    type="file" placeholder="..." style="width: 100%;">
                                                    <div class="col-lg-5 spacing-right">
                                                        <!-- Image Preview Biometric -->
                                                        <div class="image-preview42" id="imagePreview42">
                            ...
                            <button type="button" id="addOtherConsultant" class="btn btn-primary">Add More Other Consultant</button>
                        ...
                        <div class="tab-pane fade m-3" style="opacity: 90%;" id="a_address" role="tabpanel"
                            ...
                            <div class="col-lg-6 spacing-left">
                                ...
                                <div class="row ">
                                    <div class="col-lg-5 spacing-right mt-2">
                                        Email <br> <input class="form-control mt-1" value="{{ $regulators->any_a_email }}" name="any_a_email" type="text"
                                            placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-5 spacing-left mt-2">
                                        Website <br> <input class="form-control mt-1" value="{{ $regulators->any_a_web }}" name="any_a_web" type="text"
                                            placeholder="..." style="width: 100%;">
                                    </div>
                                </div>
                                <div class="row ">
                                    <div class="col-lg-5 spacing-right mt-2">
                                        Pin location <br> <input class="form-control mt-1" value="{{ $regulators->any_a_pin }}" name="any_a_pin"
                                            type="text" placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-5 spacing-left mt-2">
                                        GPS <br> <input class="form-control mt-1" value="{{ $regulators->any_a_gps }}" name="any_a_gps" type="text"
                                            placeholder="..." style="width: 100%;">
                                    </div>
                                </div>
                                <div class="row mb-2 mt-3">
                                    <div class="col-lg-5 spacing-right ">
                                        Notes <br> <textarea class="form-control mt-1" id="" name="any_a_notes"
                                            type="text" placeholder="..." style="width: 100%;">{{ $regulators->any_a_notes }}</textarea>
                                    </div>
                                    <div class="col-lg-5 spacing-left ">
                                        Attachments <br> <input class="form-control mt-1" value="{{ $regulators->any_a_attach }}" name="any_a_attach"
                                        type="file" placeholder="..." style="width: 100%;">
                                        <div class="col-lg-5 spacing-right">
                                            <!-- Image Preview Biometric -->
                                            <div class="image-preview42" id="imagePreview42">
                        ...
                        <div class="tab-pane fade m-3" style="opacity: 90%;" id="a_issuing" role="tabpanel"
                            ...
                            <div id="licenseAuthorityAccordion">
                                <!-- Existing license authority additional fields entries -->
                                @foreach ($regulators->otherissuings as $index => $oth_issuing)
                                <div class="accordion-item" id="licenseAuthorityItem{{ $index }}">
                                    <h2 class="accordion-header" id="licenseAuthorityHeading{{ $index }}">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#licenseAuthorityCollapse{{ $index }}" aria-expanded="true" aria-controls="licenseAuthorityCollapse{{ $index }}">
                                            License Authority Additional Fields {{ $index + 1 }}
                                        </button>
                                    </h2>
                                    <div id="licenseAuthorityCollapse{{ $index }}" class="accordion-collapse collapse show" aria-labelledby="licenseAuthorityHeading{{ $index }}" data-bs-parent="#licenseAuthorityAccordion">
                                        <div class="accordion-body">
                                            <div class="row mb-2">
                                                <input type="hidden" name="otherissuings[{{ $index }}][othi_id]" value="{{ $oth_issuing->id }}">
                                                <div class="col-lg-3 spacing-right">
                                                    Concerned Officer Name <br> <input class="form-control mt-1"
                                                ...
                                                <div class="row mb-2 mt-2">
                                                    <div class="col-lg-5 spacing-right mt-3">
                                                        ...
                                                        name="otherissuings[{{ $index }}][other_iss_co_notes]" type="text" placeholder="..."
                                                            style="width: 100%;">{{ $oth_issuing->other_iss_co_notes }}</textarea>
                                                    </div>
                                                    <div class="col-lg-5 spacing-left mt-3">
                                                        Attachments <br> <input class="form-control mt-1" id="head_office_email"
                            ...
                            <!-- Button to add more license authority additional fields entries -->
                            <button type="button" id="addLicenseAuthority" class="btn btn-primary">Add More License Authority Additional Fields</button>
                        </div>
                        <!--Renewals-->
                        <div class="tab-pane fade m-3" style="opacity: 90%;" id="a_weapon_renewals" role="tabpanel"
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-4 spacing-right">
                                        Notes <br> <textarea class="form-control mt-1" id="head_office_name"
                                            ...
                                            style="width: 100%;">{{ $regulators->any_ra_notes }}</textarea>
                                    </div>
                                    <div class="col-lg-4 spacing-left">
                                        Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-4 spacing-right">
                                        Notes <br> <textarea class="form-control mt-1" id="head_office_name"
                                            ...
                                            style="width: 100%;">{{ $regulators->any_rc_notes }}</textarea>
                                    </div>
                                    <div class="col-lg-4 spacing-right">
                                        Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-lg-4 spacing-right">
                                        Notes <br> <textarea class="form-control mt-1" id="head_office_name"
                                            ...
                                            style="width: 100%;">{{ $regulators->any_rap_notes }}</textarea>
                                    </div>
                                    <div class="col-lg-4 spacing-right">
                                        Attachments <br> <input class="form-control mt-1" id="head_office_email"
                            ...
                            <div id="financeAccordion">
                                <!-- Existing finance field entries -->
                                @foreach ($regulators->otherrenewals as $index => $othr_renewal)
                                <div class="accordion-item" id="financeItem{{ $index }}">
                                    <h2 class="accordion-header" id="financeHeading{{ $index }}">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#financeCollapse{{ $index }}" aria-expanded="true" aria-controls="financeCollapse{{ $index }}">
                                            Finance Fields {{ $index + 1 }}
                                        </button>
                                    </h2>
                                    <div id="financeCollapse{{ $index }}" class="accordion-collapse collapse show" aria-labelledby="financeHeading{{ $index }}" data-bs-parent="#financeAccordion">
                                        <div class="accordion-body">
                                            <div>
                                                <input type="hidden" name="otherrenewals[{{ $index }}][othr_id]" value="{{ $othr_renewal->id }}">
                                                <div class="col-lg-6 spacing-right mb-3">
                                                    Category <br> <input class="form-control mt-1" id="head_office_name"
                                                    ...
                                                    <div class="row mb-2">
                                                        ...
                                                        <div class="col-lg-4 spacing-left spacing-right mt-3">
                                                            ...
                                                            name="otherrenewals[{{ $index }}][other_finance_notes]" type="text" placeholder="..."
                                                                style="width: 100%;">{{ $othr_renewal->other_finance_notes }}</textarea>
                                                        </div>
                                                        <div class="col-lg-4 spacing-left spacing-rightmt-3">
                                                            Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                                        ...
                                                        <div class="col-lg-4 spacing-left spacing-right mt-3">
                                                            ...
                                                            name="otherrenewals[{{ $index }}][other_finance_wb_notes]"  type="text" placeholder="..."
                                                                style="width: 100%;">{{ $othr_renewal->other_finance_wb_notes }}</textarea>
                                                        </div>
                                                        <div class="col-lg-4 spacing-right">
                                                            Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                                        ...
                                                        <div class="col-lg-4 spacing-right mt-3">
                                                            ...
                                                            name="otherrenewals[{{ $index }}][other_finance_fee_notes]" type="text" placeholder="..."
                                                                style="width: 100%;">{{ $othr_renewal->other_finance_fee_notes }}</textarea>
                                                        </div>
                                                        <div class="col-lg-4 spacing-left spacing-right mt-3">
                                                            Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                                        ...
                                                        <div class="col-lg-4 spacing-left spacing-right mt-3">
                                                            ...
                                                            name="otherrenewals[{{ $index }}][other_finance_db_notes]" type="text" placeholder="..."
                                                                style="width: 100%;">{{ $othr_renewal->other_finance_db_notes }}</textarea>
                                                        </div>
                                                        <div class="col-lg-4 spacing-right">
                                                            Attachments <br> <input class="form-control mt-1" id="head_office_email"
                            ...
                            <!-- Button to add more finance fields entries -->
                            <button type="button" id="addFinanceEntry" class="btn btn-primary">Add More Finance Fields</button>
                        </div>
                        <!--Laws-->
                                ...
                                <div class="row mb-2">
                                    <div class="col-lg-4 spacing-right">
                                        Notes <br> <textarea class="form-control mt-1" id="head_office_name"
                                            ...
                                            style="width: 100%;">{{ $regulators->any_laws_notes }}</textarea>
                                    </div>
                                    <div class="col-lg-4 spacing-left spacing-right">
                                        Attachments <br> <input class="form-control mt-1" id="head_office_email"
        ...
        const newEntryHtml = `
            <div class="accordion-item" id="consultantItem${consultantCount}">
                ...
                <div id="consultantCollapse${consultantCount}" class="accordion-collapse collapse show" aria-labelledby="consultantHeading${consultantCount}" >
                    <div class="accordion-body">
                        <div class=" row mb-2">
                            <input type="hidden" name="operatingconsultants[${consultantCount - 1}][opc_id]" value="">
                        ...
                        <div class=" row ">
                            ...
                            <div class="col-lg-4 spacing-left spacing-right mt-3">
                                Notes <br> <textarea class="form-control mt-1"
                                    type="text"  name="operatingconsultants[${consultantCount - 1}][oper_notes]" placeholder="..." style="width: 100%;"></textarea>
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right mt-3">
                                Attachment <br> <input class="form-control mt-1" value="" id="head_office_email"
                        ...
                        <div class="row">
                            <div class="col-lg-5 spacing-right mt-2">
                                Email <br> <input class="form-control mt-1"  name="operatingconsultants[${consultantCount - 1}][oper_a_email]" value="" type="email"
                                    placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-5 spacing-left mt-2">
                                Website <br> <input class="form-control mt-1"  name="operatingconsultants[${consultantCount - 1}][oper_web]" value="" type="text"
                                    placeholder="..." style="width: 100%;">
                            </div>
                        </div>
                        <div class="row ">
                            <div class="col-lg-5 spacing-right mt-2">
                                Pin location <br> <input class="form-control mt-1" value=""  name="operatingconsultants[${consultantCount - 1}][oper_pin]"
                                    type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-5 spacing-left mt-2">
                                GPS <br> <input class="form-control mt-1" value=""  name="operatingconsultants[${consultantCount - 1}][oper_gps]" type="text"
                                    placeholder="..." style="width: 100%;">
                            </div>
                        </div>
                        <div class="row ">
                            <div class="col-lg-5 spacing-right mt-2">
                                Notes <br> <textarea class="form-control mt-1"  name="operatingconsultants[${consultantCount - 1}][oper_ex_notes]"
                                    type="text" placeholder="..." style="width: 100%;"></textarea>
                            </div>
                            <div class="col-lg-5 spacing-left mt-2">
                                Attachments <br> <input class="form-control mt-1"  name="operatingconsultants[${consultantCount - 1}][oper_ex_attach]" value=""
                                type="file" placeholder="..." style="width: 100%;">
                                <div class="col-lg-5 spacing-right" style="margin-left:-28px;">
                                    <div class="preview-container" id="previewContainer" style="display: flex; flex-direction: row; align-items: center;">
                                        @if($op_consultant->oper_ex_attach)
        ...
        const newEntryHtml = `
            <div class="accordion-item" id="operatingAuthorityItem${operatingAuthorityCount}">
                ...
                <div id="operatingAuthorityCollapse${operatingAuthorityCount}" class="accordion-collapse collapse show" aria-labelledby="operatingAuthorityHeading${operatingAuthorityCount}" data-bs-parent="#operatingAuthorityAccordion">
                    <div class="accordion-body">
                        <input type="hidden" name="operatingissuings[${operatingAuthorityCount - 1}][opi_id]" value="">
                        <div class="row mb-2">
                            <div class="col-lg-3 spacing-right">
                                Concerned Officer Name <br> <input class="form-control mt-1"
            ...
            <div class="accordion-item" id="operatingRenewalItem${operatingRenewalCount}">
                ...
                <div id="operatingRenewalCollapse${operatingRenewalCount}" class="accordion-collapse collapse show" aria-labelledby="operatingRenewalHeading${operatingRenewalCount}" data-bs-parent="#operatingRenewalsAccordion">
                    <div class="accordion-body">
                        <div>
                            <h3 style="border: 2px solid black; width: 99%; padding: 10px;"><b>Finances :</b></h3>
                            <input type="hidden" name="operatingrenewals[${operatingAuthorityCount - 1}][opr_id]" value="">
                            <div class="col-lg-6 spacing-right mb-3">
                                Category <br> <input class="form-control mt-1" id="head_office_name"
        ...
        const newEntryHtml = `
            <div class="accordion-item" id="weaponConsultantItem${weaponConsultantCount}">
                ...
                <div id="weaponConsultantCollapse${weaponConsultantCount}" class="accordion-collapse collapse show" aria-labelledby="weaponConsultantHeading${weaponConsultantCount}" data-bs-parent="#weaponConsultantsAccordion">
                    <div class="accordion-body">
                        <input type="hidden" name="weaponconsultants[${weaponConsultantCount - 1}][we_id]" value="">
                        <div class=" row mb-2">
                            <div class="col-lg-4 spacing-right">
                                Bank Name <br> <input class="form-control mt-1" id="head_office_name"
                            ...
                            <div class="col-lg-4 spacing-left spacing-right mt-3">
                                Notes <br> <textarea class="form-control mt-1" id="" name="weaponconsultants[${weaponConsultantCount - 1}][wep_notes]"
                                    type="text" placeholder="..." style="width: 100%;"></textarea>
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right mt-3">
                                Attachment <br> <input class="form-control mt-1" id="head_office_email"
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-5 spacing-right mt-2">
                                Email <br> <input class="form-control mt-1" value="" name="weaponconsultants[${weaponConsultantCount - 1}][wep_a_email]"
                                    placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-5 spacing-left mt-2">
                                Website <br> <input class="form-control mt-1" value="" name="weaponconsultants[${weaponConsultantCount - 1}][wep_web]"
                                    placeholder="..." style="width: 100%;">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-lg-5 spacing-right mt-2">
                                Pin location <br> <input class="form-control mt-1" value="" name="weaponconsultants[${weaponConsultantCount - 1}][wep_pin]"
                                    type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-5 spacing-left mt-2">
                                GPS <br> <input class="form-control mt-1" value="" name="weaponconsultants[${weaponConsultantCount - 1}][wep_gps]" type="text"
                                    placeholder="..." style="width: 100%;">
                            </div>
                        </div>
                        <div class="row ">
                            <div class="col-lg-5 spacing-right ">
                                Notes <br> <textarea class="form-control mt-1" name="weaponconsultants[${weaponConsultantCount - 1}][wep_ex_notes]"
                                    type="text" placeholder="..." style="width: 100%;"></textarea>
                            </div>
                            <div class="col-lg-5 spacing-left">
                                Attachments <br> <input class="form-control mt-1" value="" name="weaponconsultants[${weaponConsultantCount - 1}][wep_ex_attach]"
                                type="file" placeholder="..." style="width: 100%;">
        ...
        const newEntryHtml = `
            <div class="accordion-item" id="weaponIssuingItem${weaponIssuingCount}">
                ...
                <div id="weaponIssuingCollapse${weaponIssuingCount}" class="accordion-collapse collapse show" aria-labelledby="weaponIssuingHeading${weaponIssuingCount}" data-bs-parent="#weaponIssuingsAccordion">
                    <div class="accordion-body">
                        <div>
                            <input type="hidden" name="weaponissuings[${weaponIssuingCount - 1}][wei_id]" value="">
                            <div class="col-lg-12" >
                                <div class="row mb-2">
                                    <div class="col-lg-3 spacing-right">
                                        Concerned Officer Name <br> <input class="form-control mt-1"
                                    ...
                                    <div class="row mb-2 mt-3">
                                        <div class="col-lg-4 spacing-right">
                                            ...
                                            name="weaponissuings[${weaponIssuingCount - 1}][wep_iss_co_notes]" type="text" placeholder="..." style="width: 100%;"></textarea>
                                        </div>
                                        <div class="col-lg-4 spacing-left">
...
<script>
    // Counter to track the number of weapon details entries
    let weaponCount = {{ count($regulators->weaponlicenses) }};

    // Function to add a new weapon details entry
    function addWeaponEntry() {
        weaponCount++; // Increment the counter
        const newEntryHtml = `
            <div class="accordion-item" id="weaponItem${weaponCount}">
                <h2 class="accordion-header" id="weaponHeading${weaponCount}">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#weaponCollapse${weaponCount}" aria-expanded="true" aria-controls="weaponCollapse${weaponCount}">
                        Weapon Details ${weaponCount}
                    </button>
                </h2>
                <div id="weaponCollapse${weaponCount}" class="accordion-collapse collapse show" aria-labelledby="weaponHeading${weaponCount}" data-bs-parent="#weaponAccordion">
                    <div class="accordion-body">
                        <input type="hidden" name="weaponlicenses[${weaponCount - 1}][lic_id]" value="">
                        <div class="row mb-2">
                            <div class="col-lg-4 spacing-left spacing-right">
                                License Number <br> <input class="form-control mt-1" id="head_office_email"
                                name="weaponlicenses[${weaponCount - 1}][wep_license]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right">
                                Weapon Number <br> <input class="form-control mt-1" id="head_office_email"
                                name="weaponlicenses[${weaponCount - 1}][wep_lic_no]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right">
                                Type <br> <input class="form-control mt-1" id="head_office_email"
                                name="weaponlicenses[${weaponCount - 1}][wep_lic_type]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right mt-3">
                                Caliber <br> <input class="form-control mt-1" id="head_office_email"
                                name="weaponlicenses[${weaponCount - 1}][wep_lic_caliber]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right mt-3">
                                Jurisdiction <br> <input class="form-control mt-1" id="head_office_email"
                                name="weaponlicenses[${weaponCount - 1}][wep_lic_juris]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right mt-3">
                                Tenure of Renewal <br> <input class="form-control mt-1" id="head_office_email"
                                name="weaponlicenses[${weaponCount - 1}][wep_lic_tenure]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right mt-3">
                                Cost of Renewal <br> <input class="form-control mt-1" id="head_office_email"
                                 name="weaponlicenses[${weaponCount - 1}][wep_lic_cost]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right mt-3">
                                Expiry date <br> <input class="form-control mt-1" id="head_office_email"
                                name="weaponlicenses[${weaponCount - 1}][wep_lic_expiry]" value="" type="date" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right mt-3">
                                Sanction Date <br> <input class="form-control mt-1" id="head_office_email"
                                name="weaponlicenses[${weaponCount - 1}][wep_lic_sancdate]" value="" type="date" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right mt-3">
                                License Attachment <br> <input class="form-control mt-1" id="head_office_email"
                                name="weaponlicenses[${weaponCount - 1}][wep_lic_attach]" value="" type="file" placeholder="..." style="width: 100%;">
                                <div class="col-lg-5 spacing-right">
                                    <!-- Image Preview Biometric -->
                                    <div class="image-preview42" id="imagePreview42">
                                        @if($license->wep_lic_attach)
                            ...
                            <div class="col-lg-4 spacing-left spacing-right mt-3">
                                Weapon Dealer Name: <br> <input class="form-control mt-1" id="head_office_email"
                                name="weaponlicenses[${weaponCount - 1}][wep_lic_dealername]" value="" type="text" placeholder="..."
                                    style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right mt-3">
                                Vendor ID: <br> <input class="form-control mt-1" id="head_office_email"
                                name="weaponlicenses[${weaponCount - 1}][wep_lic_vendorid]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right mt-3">
                                Scanned Stamp of License
                                <br> <input class="form-control mt-1" id="head_office_email"
                                name="weaponlicenses[${weaponCount - 1}][wep_lic_scanned]" value="" type="file" placeholder="..." style="width: 100%;">
                                <div class="col-lg-5 spacing-right">
                                    <!-- Image Preview Biometric -->
                                    <div class="image-preview42" id="imagePreview42">
                                        @if($license->wep_lic_scanned)
                            ...
                            <div class="col-lg-4 spacing-right">
                                Endorsement From <br> <input class="form-control mt-1" id="head_office_email"
                                 name="weaponlicenses[${weaponCount - 1}][wep_lic_category]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right mt-3">
                                Endorsement Date: <br> <input class="form-control mt-1" id="wep_lic_endate"
                                name="weaponlicenses[${weaponCount - 1}][wep_lic_endate]" value="" type="date" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right ">
                                Scanned Copy of Endorsement: <br> <input class="form-control mt-1"
                                name="weaponlicenses[${weaponCount - 1}][wep_lic_encopy]" value="" type="file" placeholder="..."
                                style="width: 100%;">
                                <div class="col-lg-5 spacing-right">
                                    <!-- Image Preview Biometric -->
                                    <div class="image-preview42" id="imagePreview42">
                            ...
                            <div class="row mb-2">
                                <div class="col-lg-5 spacing-left" style="margin-left: -20px">
                                    Notes <br> <textarea class="form-control mt-1" id="head_office_name"
                                    name="weaponlicenses[${weaponCount - 1}][wep_lic_ex_notes]" type="text" placeholder="..."
                                        style="width: 87%;"></textarea>
                                </div>
                                <div class="col-lg-5 spacing-left " style="margin-left: -45px">
                                    Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                    name="weaponlicenses[${weaponCount - 1}][wep_lic_ex_attach]" value="" type="file" placeholder="..."
                                    style="width: 85%;">
                                    <div class="col-lg-5 spacing-right">
                                        <!-- Image Preview Biometric -->
                                        <div class="image-preview42" id="imagePreview42">
        ...
        `;
        // Append the new entry HTML to the container
        $('#weaponAccordion').append(newEntryHtml);
    }

    // Add event listener to the button for adding more weapon details entries
    $('#addWeaponEntry').on('click', function() {
        addWeaponEntry();
    });
</script>
        ...
        const newEntryHtml = `
            <div class="accordion-item" id="otherConsultantItem${otherConsultantCount}">
                ...
                <div id="otherConsultantCollapse${otherConsultantCount}" class="accordion-collapse collapse show" aria-labelledby="otherConsultantHeading${otherConsultantCount}" data-bs-parent="#otherConsultantsAccordion">
                    <div class="accordion-body">
                        <div class=" row mb-2">
                            <input type="hidden" name="otherconsultants[${otherConsultantCount - 1}][oth_id]" value="">
                            <div class="col-lg-4 spacing-right">
                                Consultant Name <br> <input class="form-control mt-1" id="head_office_name"
                                name="otherconsultants[${otherConsultantCount - 1}][other_name]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right">
                                Designation <br> <input class="form-control mt-1" id="head_office_email"
                                name="otherconsultants[${otherConsultantCount - 1}][other_desig]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-right">
                                Organization <br> <input class="form-control mt-1" id="head_office_name"
                                name="otherconsultants[${otherConsultantCount - 1}][other_org]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-right mt-3">
                                Cell Number <br> <input class="form-control mt-1" id="head_office_name"
                                name="otherconsultants[${otherConsultantCount - 1}][other_cell]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-left mt-3">
                                Email <br> <input class="form-control mt-1" id="head_office_name"
                                name="otherconsultants[${otherConsultantCount - 1}][other_email]" value="" type="text" placeholder="..." style="width: 103%;">
                            </div>
                            <div class="col-lg-4 spacing-right mt-3">
                                Consultancy Fees <br> <input class="form-control mt-1" id="head_office_name"
                                name="otherconsultants[${otherConsultantCount - 1}][other_fee]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-right mt-3">
                                Visiting Card Front <br> <input class="form-control mt-1" id="head_office_name"
                                name="otherconsultants[${otherConsultantCount - 1}][other_front]" value="" type="file" placeholder="..." style="width: 100%;">
                                <div class="col-lg-5 spacing-right">
                                    <!-- Image Preview Biometric -->
                                    <div class="image-preview42" id="imagePreview42">
                                        @if($oth_consultant->other_front)
                            ...
                            <div class="col-lg-4 spacing-right spacing-left mt-3">
                                Visiting Card Back <br> <input class="form-control mt-1" id="head_office_name"
                                name="otherconsultants[${otherConsultantCount - 1}][other_back]" value="" type="file" placeholder="..." style="width: 100%;">
                                <div class="col-lg-5 spacing-right">
                                    <!-- Image Preview Biometric -->
                                    <div class="image-preview42" id="imagePreview42">
                                        @if($oth_consultant->other_back)
                        ...
                        <div class=" row ">
                            <div class="col-lg-4 spacing-right">
                                Bank Name <br> <input class="form-control mt-1" id="head_office_name"
                                name="otherconsultants[${otherConsultantCount - 1}][other_bank]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right">
                                Account Title <br> <input class="form-control mt-1" id="head_office_email"
                                name="otherconsultants[${otherConsultantCount - 1}][other_account]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right">
                                Account Number <br> <input class="form-control mt-1" id="head_office_email"
                                name="otherconsultants[${otherConsultantCount - 1}][other_acc_no]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-4 spacing-right mt-3">
                                Any Agreed Financials <br> <input class="form-control mt-1"
                                name="otherconsultants[${otherConsultantCount - 1}][other_fin]" value="" type="file" placeholder="..."
                                style="width: 100%;">
                                <div class="col-lg-5 spacing-right">
                                    <!-- Image Preview Biometric -->
                                    <div class="image-preview42" id="imagePreview42">
                            ...
                            <div class="col-lg-4 spacing-left spacing-right mt-3">
                                Notes <br> <textarea class="form-control mt-1" id=""
                                name="otherconsultants[${otherConsultantCount - 1}][other_notes]" type="text" placeholder="..." style="width: 100%;"></textarea>
                            </div>
                            <div class="col-lg-4 spacing-left spacing-right mt-3">
                                Attachment <br> <input class="form-control mt-1" id="head_office_email"
                                name="otherconsultants[${otherConsultantCount - 1}][other_attachments]" value="" type="file" placeholder="..." style="width: 100%;">
                                <div class="col-lg-5 spacing-right">
                                    <!-- Image Preview Biometric -->
                                    <div class="image-preview42" id="imagePreview42">
                                        @if($oth_consultant->other_attachments)
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-5 spacing-right ">
                                Office No <br> <input class="form-control mt-1" id="head_office_cell_no"
                                name="otherconsultants[${otherConsultantCount - 1}][other_office]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-5 spacing-left">
                                Building <br> <input class="form-control mt-1" id="head_office_cell_no"
                                name="otherconsultants[${otherConsultantCount - 1}][other_build]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                        </div>
                        <div class="row ">
                            <div class="col-lg-5 spacing-right mt-2">
                                Block <br> <input class="form-control mt-1" id="head_office_cell_no"
                                name="otherconsultants[${otherConsultantCount - 1}][other_block]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-5 spacing-left mt-2">
                                Area <br> <input class="form-control mt-1" id="head_office_cell_no"
                                name="otherconsultants[${otherConsultantCount - 1}][other_area]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                        </div>
                        <div class="row ">
                            <div class="col-lg-5 spacing-right mt-2">
                                City <br> <input class="form-control mt-1" id="head_office_cell_no"
                                name="otherconsultants[${otherConsultantCount - 1}][other_city]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-5 spacing-left mt-2">
                                Photograph of Building <br> <input class="form-control mt-1" id=""
                                name="otherconsultants[${otherConsultantCount - 1}][other_photo]" value="" type="file" placeholder="..." style="width: 100%;">
                                <div class="col-lg-5 spacing-right">
                                    <!-- Image Preview Biometric -->
                                    <div class="image-preview42" id="imagePreview42">
                                        @if($oth_consultant->other_photo)
                        ...
                        <div class="row">
                            <div class="col-lg-5 spacing-right mt-2">
                                Email <br> <input class="form-control mt-1" value="" name="otherconsultants[${otherConsultantCount - 1}][other_a_email]" type="email"
                                    placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-5 spacing-left mt-2">
                                Website <br> <input class="form-control mt-1" value="" name="otherconsultants[${otherConsultantCount - 1}][other_web]" type="text"
                                    placeholder="..." style="width: 100%;">
                            </div>
                        </div>
                        <div class="row ">
                            <div class="col-lg-5 spacing-right mt-2">
                                Pin location <br> <input class="form-control mt-1" value="" name="otherconsultants[${otherConsultantCount - 1}][other_pin]"
                                    type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-5 spacing-left mt-2">
                                GPS <br> <input class="form-control mt-1" value="" name="otherconsultants[${otherConsultantCount - 1}][other_gps]" type="text"
                                    placeholder="..." style="width: 100%;">
                            </div>
                        </div>
                        <div class="row ">
                            <div class="col-lg-5 spacing-right mt-2">
                                Notes <br> <textarea class="form-control mt-1" id="" name="otherconsultants[${otherConsultantCount - 1}][other_ex_notes]"
                                    type="text" placeholder="..." style="width: 100%;"></textarea>
                            </div>
                            <div class="col-lg-5 spacing-left mt-2">
                                Attachments <br> <input class="form-control mt-1" value="" name="otherconsultants[${otherConsultantCount - 1}][other_ex_attach]"
                                type="file" placeholder="..." style="width: 100%;">
                                <div class="col-lg-5 spacing-right">
                                    <!-- Image Preview Biometric -->
                                    <div class="image-preview42" id="imagePreview42">
...
<!-- Script for dynamic addition of license authority additional fields entries -->
<script>
    // Counter to track the number of license authority additional fields entries
    let licenseAuthorityCount = {{ count($regulators->otherissuings) }};

    // Function to add a new license authority additional fields entry
    function addLicenseAuthorityEntry() {
        licenseAuthorityCount++; // Increment the counter
        const newEntryHtml = `
            <div class="accordion-item" id="licenseAuthorityItem${licenseAuthorityCount}">
                <h2 class="accordion-header" id="licenseAuthorityHeading${licenseAuthorityCount}">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#licenseAuthorityCollapse${licenseAuthorityCount}" aria-expanded="true" aria-controls="licenseAuthorityCollapse${licenseAuthorityCount}">
                        License Authority Additional Fields ${licenseAuthorityCount}
                    </button>
                </h2>
                <div id="licenseAuthorityCollapse${licenseAuthorityCount}" class="accordion-collapse collapse show" aria-labelledby="licenseAuthorityHeading${licenseAuthorityCount}" data-bs-parent="#licenseAuthorityAccordion">
                    <div class="accordion-body">
                        <div class="row mb-2">
                            <input type="hidden" name="otherissuings[${licenseAuthorityCount - 1}][othi_id]" value="">

                            <div class="col-lg-3 spacing-right">
                                Concerned Officer Name <br> <input class="form-control mt-1"
                                    id="other_cn_officer"  name="otherissuings[${licenseAuthorityCount - 1}][other_iss_co_name]" value="" type="text" placeholder="..."
                                    style="width: 100%;">
                            </div>
                            <div class="col-lg-3 spacing-left spacing-right">
                                Designation <br> <input class="form-control mt-1" id="oper_desig"
                                name="otherissuings[${licenseAuthorityCount - 1}][other_iss_co_desig]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-3 spacing-right">
                                Department <br> <input class="form-control mt-1" id="head_office_name"
                                name="otherissuings[${licenseAuthorityCount - 1}][other_iss_co_dept]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-3 spacing-right">
                                Section <br> <input class="form-control mt-1" id="head_office_name"
                                name="otherissuings[${licenseAuthorityCount - 1}][other_iss_co_section]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-3 spacing-right mt-3">
                                PTCL Number <br> <input class="form-control mt-1" id="head_office_name"
                                name="otherissuings[${licenseAuthorityCount - 1}][other_iss_co_ptcl]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>

                            <div class="col-lg-3 spacing-left mt-3">
                                Cell Number <br> <input class="form-control mt-1" id="head_office_name"
                                name="otherissuings[${licenseAuthorityCount - 1}][other_iss_co_cell]" value="" type="text" placeholder="..." style="width: 105%;">
                            </div>
                            <div class="col-lg-3 spacing-right mt-3">
                                Email <br> <input class="form-control mt-1" id="head_office_name"
                                name="otherissuings[${licenseAuthorityCount - 1}][other_iss_co_email]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-3 spacing-right mt-3">
                                Website <br> <input class="form-control mt-1" id="head_office_name"
                                name="otherissuings[${licenseAuthorityCount - 1}][other_iss_co_web]" value="" type="text" placeholder="..." style="width: 100%;">
                            </div>
                            <div class="col-lg-3 spacing-right mt-3">
                                Visiting Card Front <br> <input class="form-control mt-1" id="head_office_name"
                                name="otherissuings[${licenseAuthorityCount - 1}][other_iss_co_front]" value="" type="file" placeholder="..." style="width: 100%;">
                                <div class="col-lg-5 spacing-right">
                                    <!-- Image Preview Biometric -->
                                    <div class="image-preview42" id="imagePreview42">
                                        @if($oth_issuing->other_iss_co_front)
                            ...
                            <div class="col-lg-3 spacing-right spacing-left mt-3">
                                Visiting Card Back <br> <input class="form-control mt-1" id="head_office_name"
                               name="otherissuings[${licenseAuthorityCount - 1}][other_iss_co_back]" value="" type="file" placeholder="..." style="width: 100%;">
                                <div class="col-lg-5 spacing-right">
                                    <!-- Image Preview Biometric -->
                                    <div class="image-preview42" id="imagePreview42">
                                        @if($oth_issuing->other_iss_co_back)
                            ...
                            <div class="row mb-2 mt-2">
                                <div class="col-lg-5 spacing-right mt-3">
                                    Notes <br> <textarea class="form-control mt-1" id="head_office_name"
                                    name="otherissuings[${licenseAuthorityCount - 1}][other_iss_co_notes]" type="text" placeholder="..."
                                        style="width: 100%;"></textarea>
                                </div>
                                <div class="col-lg-5 spacing-left mt-3">
                                    Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                  name="otherissuings[${licenseAuthorityCount - 1}][other_iss_co_attach]" value="" type="file" placeholder="..."
                                    style="width: 100%;">
                                    <div class="col-lg-5 spacing-right">
                                        <!-- Image Preview Biometric -->
                                        <div class="image-preview42" id="imagePreview42">
        ...
        `;
        // Append the new entry HTML to the container
        $('#licenseAuthorityAccordion').append(newEntryHtml);
    }

    // Add event listener to the button for adding more license authority additional fields entries
    $('#addLicenseAuthority').on('click', function() {
        addLicenseAuthorityEntry();
    });
</script>

<script>
    // Counter to track the number of finance fields entries
    let financeCount = {{ count($regulators->otherrenewals) }};

    // Function to add a new finance fields entry
        ...
        const newEntryHtml = `
            <div class="accordion-item" id="financeItem${financeCount}">
                ...
                <div id="financeCollapse${financeCount}" class="accordion-collapse collapse show" aria-labelledby="financeHeading${financeCount}" data-bs-parent="#financeAccordion">
                    <div class="accordion-body">
                        <div>
                            <input type="hidden" name="otherrenewals[${financeCount - 1}][othr_id]" value="">
                            <div class="col-lg-6 spacing-right mb-3">
                                Category <br> <input class="form-control mt-1" id="head_office_name"
                                name="otherrenewals[${financeCount - 1}][other_fee_category]"  value="" type="text" placeholder="..."
                                style="width: 100%;">
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="row mb-2">
                                    <div class="col-lg-4 spacing-right">
                                        Bank Name <br> <input class="form-control mt-1" id="head_office_name"
                                        name="otherrenewals[${financeCount - 1}][other_finance_bank]"  value="" type="text" placeholder="..."
                                            style="width: 100%;">
                                    </div>
                                    <div class="col-lg-4 spacing-left spacing-right">
                                        Cheque/Instrument No. <br> <input class="form-control mt-1"
                                        name="otherrenewals[${financeCount - 1}][other_finance_cheque]"  value="" type="text"
                                            placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-4 spacing-right">
                                        Scanned copy of Cheque/Instrument<br> <input class="form-control mt-1"
                                        name="otherrenewals[${financeCount - 1}][other_finance_copy]"  value="" type="file"
                                            placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-4 spacing-right mt-3">
                                        Amount in figures <br> <input class="form-control mt-1"
                                        name="otherrenewals[${financeCount - 1}][other_finance_amount]"  value="" type="text"
                                            placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-4 spacing-left spacing-right mt-3">
                                        Notes <br> <textarea class="form-control mt-1" id="head_office_name"
                                       name="otherrenewals[${financeCount - 1}][other_finance_notes]"  type="text" placeholder="..."
                                            style="width: 100%;"></textarea>
                                    </div>
                                    <div class="col-lg-4 spacing-left spacing-rightmt-3">
                                        Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                        name="otherrenewals[${financeCount - 1}][other_finance_attach]"  value="" type="file" placeholder="..."
                                        style="width: 100%;">
                                        <div class="col-lg-5 spacing-right">
                                            <!-- Image Preview Biometric -->
                                            <div class="image-preview42" id="imagePreview42">
                                    ...
                                    <div class="col-lg-4 spacing-right">
                                        Name <br> <input class="form-control mt-1" id="head_office_name"
                                       name="otherrenewals[${financeCount - 1}][other_finance_wb_name]"  value="" type="text" placeholder="..."
                                            style="width: 100%;">
                                    </div>
                                    <div class="col-lg-4 spacing-left spacing-right">
                                        Employee ID <br> <input class="form-control mt-1" id="head_office_email"
                                         name="otherrenewals[${financeCount - 1}][other_finance_wb_id]"  value="" type="text" placeholder="..."
                                            style="width: 100%;">
                                    </div>
                                    <div class="col-lg-4 spacing-right">
                                        Designation <br> <input class="form-control mt-1" id="head_office_name"
                                         name="otherrenewals[${financeCount - 1}][other_finance_wb_desig]"  value="" type="text" placeholder="..."
                                            style="width: 100%;">
                                    </div>
                                    <div class="col-lg-4 spacing-right mt-3">
                                        Cell Number <br> <input class="form-control mt-1" id="head_office_name"
                                        name="otherrenewals[${financeCount - 1}][other_finance_wb_cell]"  value="" type="text" placeholder="..."
                                            style="width: 100%;">
                                    </div>
                                    <div class="col-lg-4 spacing-left mt-3">
                                        Email ID <br> <input class="form-control mt-1" id="head_office_name"
                                        name="otherrenewals[${financeCount - 1}][other_finance_wb_email]"  value="" type="text" placeholder="..."
                                            style="width: 103%;">
                                    </div>
                                    <div class="col-lg-4 spacing-left spacing-right mt-3">
                                        Notes <br> <textarea class="form-control mt-1" id="head_office_name"
                                        name="otherrenewals[${financeCount - 1}][other_finance_wb_notes]"   type="text" placeholder="..."
                                            style="width: 100%;">{{ $othr_renewal->other_finance_wb_notes }}</textarea>
                                    </div>
                                    <div class="col-lg-4 spacing-right">
                                        Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                        name="otherrenewals[${financeCount - 1}][other_finance_wb_attach]"  value="" type="file" placeholder="..."
                                        style="width: 100%;">
                                        <div class="col-lg-5 spacing-right">
                                            <!-- Image Preview Biometric -->
                                            <div class="image-preview42" id="imagePreview42">
                                    ...
                                    <div class="col-lg-4 spacing-right">
                                        Fees <br> <input class="form-control mt-1" id="head_office_name"
                                        name="otherrenewals[${financeCount - 1}][other_finance_fee]"  value="" type="text" placeholder="..."
                                            style="width: 100%;">
                                    </div>
                                    <div class="col-lg-4 spacing-left spacing-right lh-lg">
                                        Date of Fees Deposit <br> <input class="form-control mt-1"
                                        name="otherrenewals[${financeCount - 1}][other_finance_fee_date]"  value="" type="date"
                                            placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-4 spacing-right lh-lg">
                                        Name of bank<br> <input class="form-control mt-1" id="head_office_name"
                                         name="otherrenewals[${financeCount - 1}][other_finance_fee_bank]"  value="" type="text" placeholder="..."
                                            style="width: 100%;">
                                    </div>
                                    <div class="col-lg-4 spacing-right mt-3">
                                        Instrument Number <br> <input class="form-control mt-1"
                                        name="otherrenewals[${financeCount - 1}][other_finance_fee_ins]"  value="" type="text"
                                            placeholder="..." style="width: 100%;">
                                    </div>
                                    <div class="col-lg-4 spacing-left spacing-right mt-3">
                                        Deposit Slip Attachment <br> <input class="form-control mt-1"
                                        name="otherrenewals[${financeCount - 1}][other_finance_slip_attach]"  value="" type="file"
                                        placeholder="..." style="width: 100%;">
                                        <div class="col-lg-5 spacing-right">
                                            <!-- Image Preview Biometric -->
                                            <div class="image-preview42" id="imagePreview42">
                                    ...
                                    <div class="col-lg-4 spacing-right mt-3">
                                        Notes <br> <textarea class="form-control mt-1" id="head_office_name"
                                        name="otherrenewals[${financeCount - 1}][other_finance_fee_notes]"  type="text" placeholder="..."
                                            style="width: 100%;"></textarea>
                                    </div>
                                    <div class="col-lg-4 spacing-left spacing-right mt-3">
                                        Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                         name="otherrenewals[${financeCount - 1}][other_finance_fee_attach]"  value="" type="file" placeholder="..."
                                        style="width: 100%;">
                                        <div class="col-lg-5 spacing-right">
                                            <!-- Image Preview Biometric -->
                                            <div class="image-preview42" id="imagePreview42">
                                    ...
                                    <div class="col-lg-4 spacing-right">
                                        Name <br> <input class="form-control mt-1" id="head_office_name"
                                       name="otherrenewals[${financeCount - 1}][other_finance_db_name]"  value="" type="text" placeholder="..."
                                            style="width: 100%;">
                                    </div>
                                    <div class="col-lg-4 spacing-left spacing-right">
                                        Employee ID <br> <input class="form-control mt-1" id="head_office_email"
                                        name="otherrenewals[${financeCount - 1}][other_finance_db_id]"  value="" type="text" placeholder="..."
                                            style="width: 100%;">
                                    </div>
                                    <div class="col-lg-4 spacing-right">
                                        Designation <br> <input class="form-control mt-1" id="head_office_name"
                                         name="otherrenewals[${financeCount - 1}][other_finance_db_desig]"  value="" type="text" placeholder="..."
                                            style="width: 100%;">
                                    </div>
                                    <div class="col-lg-4 spacing-right mt-3">
                                        Cell Number <br> <input class="form-control mt-1" id="head_office_name"
                                         name="otherrenewals[${financeCount - 1}][other_finance_db_cell]"  value="" type="text" placeholder="..."
                                            style="width: 100%;">
                                    </div>
                                    <div class="col-lg-4 spacing-left mt-3">
                                        Email ID <br> <input class="form-control mt-1" id="head_office_name"
                                         name="otherrenewals[${financeCount - 1}][other_finance_db_email]"  value="" type="text" placeholder="..."
                                            style="width: 103%;">
                                    </div>
                                    <div class="col-lg-4 spacing-left spacing-right mt-3">
                                        Notes <br> <textarea class="form-control mt-1" id="head_office_name"
                                         name="otherrenewals[${financeCount - 1}][other_finance_db_notes]"  type="text" placeholder="..."
                                            style="width: 100%;"></textarea>
                                    </div>
                                    <div class="col-lg-4 spacing-right">
                                        Attachments <br> <input class="form-control mt-1" id="head_office_email"
                                        name="otherrenewals[${financeCount - 1}][other_finance_db_attach]"  value="" type="file" placeholder="..."
                                        style="width: 100%;">
                                        <div class="col-lg-5 spacing-right">
                                            <!-- Image Preview Biometric -->
                                            <div class="image-preview42" id="imagePreview42">
    ...
    // Add event listener to the button for adding more finance fields entries
    $('#addFinanceEntry').on('click', function() {
        addFinanceEntry();
    });
</script>
        ...
        divtest.innerHTML = `
                ...
                <div class="col-lg-4 spacing-right">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" id="leadcustom-category"
